...
<head>
  <meta charset="utf-8" />
  <title>TELKOM COOPERATIVE| Login Page</title>
...
<body class="login">
  <!-- BEGIN LOGO -->
  <div class="logo">
    <!-- <h3 style="color:white">KOPERASI</h3> -->
    <img src="<?php echo base_url('assets/img/logo-koptel.png'); ?>" style="height:150px;">
  </div>
  <!-- END LOGO -->
  <!-- BEGIN LOGIN -->
  <div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="form-vertical login-form" method="post" action="<?php echo site_url('login/authentication'); ?>">
      <h3 class="form-title" align="center">Login to KOPAS TELCO</h3>
      <?php
      if($this->session->flashdata('login_message')==true)
      {
      ?>
      ...
      <div class="form-actions" style="border-bottom:0;margin-bottom:10px;">
  ...
  <script>
    ...
    $(function(){
      $("#username",".login-form").keydown(function(e){
          if(e.keyCode==13){
            $("#password",".login-form").select();
            return false;
          }
      })
    })
