...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Rekening Nasabah <small>Registrasi Transfer Pencairan</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
      ...
      <li><a href="#">Registrasi Transfer Pencairan</a></li> 
    </ul>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Registrasi Transfer Pencairan</div>
      <div class="tools">
...
<div id="add" style="display:none;">
  <div class="portlet box purple">
    <div class="portlet-title">
       <div class="caption"><i class="icon-reorder"></i>Registrasi Transfer Pencairan</div>
       <div class="tools">
          <a href="javascript:;" class="collapse"></a>
       </div>
    </div>
    <div class="portlet-body form">
      ...
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="form-actions">
           <button type="submit" class="btn purple" id="register">Register</button>
...
table = $('#transfer_pencairan').dataTable({
  "bProcessing": true,
  "bServerSide": true,
  "sAjaxSource": site_url+"rekening_nasabah/datatable_registrasi_transfer_pencairan",
  "aoColumns": [
    null,
    null,
    null,
...
$('a#link-registrasi').live('click',function(){
  $('#add').show();
  $('#wrapper-table').hide();
  ...
  $.ajax({
    ...
    success:function(response) {
      ...
      $('#biaya_asuransi').val(number_format(response.biaya_asuransi,0,',','.'))
...
$('#form').validate({
  ...
  submitHandler: function (form) {
    $.ajax({
      ...
      ,url: site_url+'/rekening_nasabah/do_registrasi_transfer_pencairan',
      success:function(response) {
        if (response.success===true) {
          $.alert({
            title:"Sukses",icon:'icon-check',backgroundDismiss:false,
            confirmButtonClass:'btn green',content:'Registrasi Transfer Pencairan SUKSES',
            confirm:function() {
              table.fnReloadAjax();          
              $('.alert-success').hide();
              $('.alert-error').hide();
