...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Rekening Nasabah <small>Pencairan Nasabah</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
      ...
      <li><a href="#">Pencairan Nasabah</a></li> 
    </ul>
...
<div class="portlet box red" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Pencairan Nasabah</div>
      <div class="tools">
      ...
      <form action="#" id="form" class="form-horizontal">
        ...
        <div class="form-body" style="padding-top:20px;padding-bottom:20px;">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="tanggal_transfer" id="tanggal_transfer" data-required="1" class="small m-wrap" placeholder="DD/MM/YYYY" style="background:#f5f5f5" />
            </div>
          </div>
          <div class="control-group">
