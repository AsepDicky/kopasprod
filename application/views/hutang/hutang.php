...
<div id="add">
  ...
  <div class="portlet box <?= $boxcolor ?>">
    ...
    <div class="portlet-title">
      <div class="caption"><i class="icon-upload"></i><?= $title ?> 2022</div>
    </div>

    <?php if ($fileupload) : ?>
      <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="<?php echo site_url('hutang/do_upload_pengajuan'); ?>" method="post" enctype="multipart/form-data" id="FormAdd" class="form-horizontal">
    ...
    <div class="portlet-body form">
      ...
      <div class="append-bu" style="float:right;margin-right:10px;">
        <a href="<?= base_url() ?>assets/template_excel/DATA_TEMPLETE_MIGRASI_2018.xlsx" download class="btn yellow" style="padding:7px 10px;margin-right:5px">
          Download Template Pengajuan Hutang <i class="icon-cloud-download"></i>
        </a>
  ...
  <script>
    $(function() {
      ...
      $("#jqGrid_pengajuan").jqGrid({
        url: site_url + 'hutang/jqGrid_pengajuan',
        mtype: "GET",
        datatype: "json",
        postData: {
          file_name: function() {
        ...
        colModel: [{
          ...
          {
            label: 'angsuran_margin',
            name: 'angsuran_margin',
            width: 90,
            align: 'left',
            hidden: true
          },
          ...
          },
          {
            ...
            name: 'saldo_kewajiban_ke_koptel',
            width: 90,
            align: 'right',
            hidden: true
          },
          ...
          {
            label: 'show_masa_pensiun',
            name: 'show_masa_pensiun',
            width: 90,
            align: 'left',
            hidden: true
          },
          ...
          {
            label: 'status_financing_reg',
            name: 'status_financing_reg',
            width: 90,
            align: 'left',
            hidden: true
          },
          ...
          {
            label: 'Pengajuan Melalui',
            name: 'pengajuan_melalui',
            width: 90,
            align: 'left',
            hidden: true
          },
      ...
      $("#save_trx").click(function(e) {
        ...
        var masa_pensiun = [];
        var show_masa_pensiun = [];
        var kopegtel = [];
        var status_financing_reg = [];
        var flag_thp100 = [];
        var gender = [];
        var jenis_margin = [];
        ...
        for ($i = 0; $i < data.length; $i++) {
          ...
          tahap[$i] = data[$i].tahap;
          virtual_account[$i] = data[$i].virtual_account;
        ...
        if (data.length < 0) {
          ...
          $.blockUI({
            message: '<div style="padding:5px 0;">Saving.. Please Wait...</div>',
            css: {
              backgroundColor: '#fff',
              color: '#000',
              fontSize: '12px'
          ...
          $.ajax({
            ...
            dataType: "json",
            data: inputpost,
            url: site_url + 'hutang/' + $('#savefile').val(),
            error: function() {
              $.unblockUI
