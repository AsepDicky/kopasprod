      ...
      <div class="portlet-body form">
         ...
         <form action="<?php echo site_url('cif/add_cif_individu'); ?>" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input name="tgl_lahir" id="mask_date" type="text" class="date-picker-tgl-lahir small m-wrap"/>
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input name="desa" id="desa" type="text" class="medium m-wrap" maxlength="30" />
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">Kecamatan<br><small>(Alamat Rumah)</small></label>
               <div class="controls">
                  <input name="kecamatan" id="kecamatan" type="text" class="medium m-wrap" maxlength="30" />
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">Kabupaten/Kota<br><small>(Alamat Rumah)</small></label>
               <div class="controls">
                  <input name="kabupaten" id="kabupaten" type="text" class="medium m-wrap" maxlength="30" />
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">Kode Pos<br><small>(Alamat Rumah)</small></label>
               <div class="controls">
                  <input name="kode_pos" id="kode_pos" type="text" class="small m-wrap" maxlength="6" />
               </div>
            </div>
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select class="small m-wrap" name="jenis_id" id="jenis_id">
                  ...
                  <span id="lainnya" style="display:none;"><input name="jenis_id2" id="jenis_id2" type="text" class="small m-wrap" maxlength="16" /></span>
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">No. Identitas</label>
               <div class="controls">
                  <input name="no_ktp_is_exist" id="no_ktp_is_exist" type="hidden"/>
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input name="no_npwp" id="no_npwp" type="text" class="medium m-wrap" maxlength="20" />
               </div>
            </div>
            <div class="control-group">
               ...
               <div class="controls">
                 <select name="pendidikan" id="pendidikan">
                   ...
                   <option>S1 & S2</option>
                   <option>D3 atau setingkat</option>
                   <option>SMA atau sederajat</option>
                   <option>SMP atau sederajat</option>
                   <option>SD atau sederajat</option>
                 </select>
               </div>
            </div>
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="pekerjaan" id="pekerjaan" class="medium m-wrap">
                    ...
                    <option><?php echo $key['display_text'];?></option>
                    <?php endforeach;?>
                  </select>
               </div>
            </div>
            <div class="control-group">
               ...
               <div class="controls">
                  <div class="input-prepend input-append">
                     ...
                     <input name="pendapatan" id="pendapatan" type="text" class="mask-money medium m-wrap"/>
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" name="nama_pasangan" id="nama_pasangan" data-required="1" class="medium m-wrap" onkeyup="this.value=this.value.toUpperCase()" disabled="disabled" style="background-color:#EEE"/>
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">Jenis Identitas Pasangan</label>
               <div class="controls">
                  <select class="small m-wrap" name="jenis_id_pasangan" id="jenis_id_pasangan" disabled="disabled" style="background-color:#EEE">
                     <option value="">Pilih</option>
                     <option value="KTP">KTP</option>
                     <option value="SIM">SIM</option>
                     <option value="PASPOR">PASPOR</option>
                  ...
                  <span id="lainnya2" style="display:none;"><input name="jenis_id_pasangan2" id="jenis_id_pasangan2" type="text" class="small m-wrap" maxlength="16" /></span>
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">No. Identitas Pasangan</label>
               <div class="controls">
                  <input name="no_ktp_pasangan_is_exist" id="no_ktp_pasangan_is_exist" type="hidden"/>
                  <input name="identitas_pasangan" id="identitas_pasangan" type="text" class="medium m-wrap" disabled="disabled" style="background-color:#EEE"/>
               </div>
            </div>
...
$(function(){
      ...
      form1.validate({
          ...
          submitHandler: function(){
            var jenis_id = $("#jenis_id",form1).val();
            var jenis_id_pasangan = $("#jenis_id_pasangan",form1).val();
            var jenis_id2 = $("#jenis_id2",form1).val();
            var jenis_id_pasangan2 = $("#jenis_id_pasangan2",form1).val();
            var no_ktp = $("#no_ktp",form1).val();
            var identitas_pasangan = $("#identitas_pasangan",form1).val();
            ...
            /*Check jenis Identitas CIF*/
            $.ajax({
              type:"POST",dataType:"json",
              data:{id_jenis:id_jenis,no_ktp:no_ktp},
              url:site_url+'cif/ajax_no_identitas_same_is_exists',
              async: false,
              success:function(response){
                $("#no_ktp_is_exist",form1).val(response.result);
              }
            });

            no_ktp_is_exist = $("#no_ktp_is_exist",form1).val();

            /*Check jenis Identitas Pasangan*/
            $.ajax({
              type:"POST",dataType:"json",
              data:{id_jenis:id_jenis,no_ktp:no_ktp},
              url:site_url+'cif/ajax_no_identitas_pasangan_same_is_exists',
              async: false,
              success:function(response){
                $("#no_ktp_pasangan_is_exist",form1).val(response.result);
              }
            });

            no_ktp_pasangan_is_exist = $("#no_ktp_pasangan_is_exist",form1).val();

            if(no_ktp_is_exist==1){
              alert("Warning : Double No Identitas. Tidak bisa mendaftarkan anggota dengan nomer identitas yang sama !");
            }else if(no_ktp_pasangan_is_exist==1){
              alert("Warning : Double No Identitas Pasangan. Tidak bisa mendaftarkan anggota dengan nomer identitas Pasangan yang sama !");
            }else{
                form1.ajaxSubmit({
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            if (response.koresponden_rt_rw!=null) {
            ...
            var jenis_id = response.jenis_id;
            var nama_pasangan = response.nama_pasangan;
            var jenis_id_pasangan = response.jenis_id_pasangan;
            var status_perkawinan = response.status_perkawinan;
            if(jenis_id=="KTP" || jenis_id=="SIM" || jenis_id=="PASPOR"){
               $("#lainnya",form2).hide();
               $("#jenis_id2",form2).val('');
               $("#jenis_id",form2).val(response.jenis_id);
            }else{
               $("#lainnya",form2).show();
               $("#jenis_id2",form2).val(response.jenis_id);
               $("#jenis_id",form2).val('dll');
            }
            if(jenis_id_pasangan=="KTP" || jenis_id_pasangan=="SIM" || jenis_id_pasangan=="PASPOR"){
               $("#lainnya2",form2).hide();
               $("#jenis_id_pasangan2",form2).val('');
               $("#jenis_id_pasangan",form2).val(response.jenis_id_pasangan);
            }else{
               $("#lainnya2",form2).show();
               $("#jenis_id_pasangan2",form2).val(response.jenis_id_pasangan);
               $("#jenis_id_pasangan",form2).val('dll');
            }
            if(status_perkawinan=='0'){
               $("#nama_pasangan",form2).attr('disabled',false);
               $("#jenis_id_pasangan",form2).attr('disabled',false);
               $("#identitas_pasangan",form2).attr('disabled',false);
               $("#nama_pasangan",form2).css('backgroundColor','#FFFFFF');
               $("#jenis_id_pasangan",form2).css('backgroundColor','#FFFFFF');
               $("#identitas_pasangan",form2).css('backgroundColor','#FFFFFF');
            }else{
               $("#nama_pasangan",form2).attr('disabled',true);
               $("#jenis_id_pasangan",form2).attr('disabled',true);
               $("#identitas_pasangan",form2).attr('disabled',true);
               $("#nama_pasangan",form2).css('backgroundColor','#EFEFEF');
               $("#jenis_id_pasangan",form2).css('backgroundColor','#EFEFEF');
               $("#identitas_pasangan",form2).css('backgroundColor','#EFEFEF');
               $("#lainnya2",form2).hide();
            }
            $("#nama_pasangan",form2).val(nama_pasangan);
            ...
            if ( sama == true )
               $("#sama",form2).attr('checked',true).closest('span').attr('class','checked');
            else
               $("#sama",form2).attr('checked',false).closest('span').removeAttr('class');
          }
        })
      ...
      $("#sama",form2).click(function(){
         ...
         if($(this).is(':checked')==true){
            ...
            $("#koresponden_kodepos",form2).val($("#kodepos",form2).val());
         }else{
      ...
      $("#jenis_id","#form_add").change(function(){
         var jenis_id = $(this).val();
         if(jenis_id=="dll"){
            $("#lainnya","#form_add").show();
         }else{
            $("#lainnya","#form_add").hide();
            $("#jenis_id2","#form_edit").val('');
         }
      })

      $("#jenis_id_pasangan","#form_add").change(function(){
         var jenis_id = $(this).val();
         if(jenis_id=="dll"){
            $("#lainnya2","#form_add").show();
         }else{
            $("#lainnya2","#form_add").hide();
            $("#jenis_id_pasangan2","#form_edit").val('');
         }
      })

      $("#status_perkawinan","#form_add").change(function(){
         var status_perkawinan = $(this).val();
         if(status_perkawinan=='0'){
            $("#nama_pasangan","#form_add").attr('disabled',false);
            $("#jenis_id_pasangan","#form_add").attr('disabled',false);
            $("#identitas_pasangan","#form_add").attr('disabled',false);
            $("#nama_pasangan","#form_add").css('backgroundColor','#FFFFFF');
            $("#jenis_id_pasangan","#form_add").css('backgroundColor','#FFFFFF');
            $("#identitas_pasangan","#form_add").css('backgroundColor','#FFFFFF');
         }else{
            $("#nama_pasangan","#form_add").attr('disabled',true);
            $("#jenis_id_pasangan","#form_add").attr('disabled',true);
            $("#identitas_pasangan","#form_add").attr('disabled',true);
            $("#nama_pasangan","#form_add").css('backgroundColor','#EFEFEF');
            $("#jenis_id_pasangan","#form_add").css('backgroundColor','#EFEFEF');
            $("#identitas_pasangan","#form_add").css('backgroundColor','#EFEFEF');
            $("#nama_pasangan","#form_add").val('');
            $("#jenis_id_pasangan","#form_add").val('');
            $("#identitas_pasangan","#form_add").val('');
         }
      })

      $("#jenis_id","#form_edit").change(function(){
         var jenis_id = $(this).val();
         if(jenis_id=="dll"){
            $("#lainnya","#form_edit").show();
         }else{
            $("#lainnya","#form_edit").hide();
            $("#jenis_id2","#form_edit").val('');
         }
      })

      $("#jenis_id_pasangan","#form_edit").change(function(){
         var jenis_id = $(this).val();
         if(jenis_id=="dll"){
            $("#lainnya2","#form_edit").show();
         }else{
            $("#lainnya2","#form_edit").hide();
            $("#jenis_id_pasangan2","#form_edit").val('');
         }
      })

      $("#status_perkawinan","#form_edit").change(function(){
         var status_perkawinan = $(this).val();
         if(status_perkawinan=='0'){
            $("#nama_pasangan","#form_edit").attr('disabled',false);
            $("#jenis_id_pasangan","#form_edit").attr('disabled',false);
            $("#identitas_pasangan","#form_edit").attr('disabled',false);
            $("#nama_pasangan","#form_edit").css('backgroundColor','#FFFFFF');
            $("#jenis_id_pasangan","#form_edit").css('backgroundColor','#FFFFFF');
            $("#identitas_pasangan","#form_edit").css('backgroundColor','#FFFFFF');
         }else{
            $("#nama_pasangan","#form_edit").attr('disabled',true);
            $("#jenis_id_pasangan","#form_edit").attr('disabled',true);
            $("#identitas_pasangan","#form_edit").attr('disabled',true);
            $("#nama_pasangan","#form_edit").css('backgroundColor','#EFEFEF');
            $("#jenis_id_pasangan","#form_edit").css('backgroundColor','#EFEFEF');
            $("#identitas_pasangan","#form_edit").css('backgroundColor','#EFEFEF');
            $("#nama_pasangan","#form_edit").val('');
            $("#jenis_id_pasangan","#form_edit").val('');
            $("#identitas_pasangan","#form_edit").val('');
         }
      })
