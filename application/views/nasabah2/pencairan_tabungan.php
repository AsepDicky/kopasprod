...
<div class="row-fluid">
   <div class="span12">
    ...
    <!-- BEGIN PAGE TITLE & BREADCRUMB-->
      <h3 class="page-title">
        Rekening Nasabah <small>Pencairan Rekening Tabungan Berencana</small>
      </h3>
      <ul class="breadcrumb">
        <li>
          <i class="icon-home"></i>
...
<div id="add">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Registrasi Pencairan Rekening Tabungan Berencana</div>
         <div class="tools">
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
          ...
          <div class="alert alert-success hide">
             <button class="close" data-dismiss="alert"></button>
             Transaksi Pencairan Tabungan Berencana Berhasil. Silahkan Lakukan Verifikasi !
          </div>
          <h3 class="form-section">Pencairan Rekening Tabungan Berencana</h3> 
            ...
            <input type="hidden" value="PINBUK" name="pencairan_ke" id="pencairan_ke" data-required="1" class="medium m-wrap" readonly="" style="background-color:#eee;"/>
           <!--  <div class="control-group">
...
<script type="text/javascript">
      ...
      form1.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"rekening_nasabah/proses_pencairan_tabungan",
              dataType: "json",
