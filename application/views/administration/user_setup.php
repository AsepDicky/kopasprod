   ...
   <div class="portlet-body">
      <div class="clearfix">
         ...
         <div class="btn-group pull-right">
            <?php
            $check_free = $this->db->query("SELECT * FROM mfi_user_device_list WHERE device_id='free'")->num_rows();
            if($check_free > 0){
            ?>
               <button data-val="lock" class="btn default btn_device">
                 Lock All Device <i class="icon-lock"></i>
               </button>
            <?php   
            }else{
            ?>
               <button data-val="free" class="btn blue btn_device">
                 Free All Device <i class="icon-unlock"></i>
               </button>
            <?php
            }
            ?>
      ...
      <div class="portlet-body form">
         ...
         <form action="<?php echo site_url('administration/add_user'); ?>" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" name="username" data-required="1" class="medium m-wrap"/>
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select class="medium m-wrap" name="kode_jabatan">
                     <option value="">Select...</option>
                     <?php
                     foreach($jabatan as $jabat):
                     ?>
                     <option value="<?php echo $jabat['kode_jabatan']; ?>"><?php echo $jabat['kode_jabatan'].' - '.$jabat['nama_jabatan']; ?></option>
                     <?php
                     endforeach;
                     ?>
                  </select>
   ...
   <div class="portlet box purple">
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_edit" class="form-horizontal">
            ...
            <hr>
            <input id="getDeviceID" type="hidden" value="<?= $deviceID ?>" />
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <textarea class="form-control large m-wrap" name="deviceID" id="deviceID" rows="3"></textarea>
                  <button type="button" id="setDeviceID" class="btn btn-circle blue">Set DEVICE ID</button>
               </div>
            </div>
            <div class="form-actions">
...
$(function(){
      ...
      $("#setDeviceID").click(function(){
         var getDeviceID = $("#getDeviceID").val();
         var deviceID = $("#deviceID").val();

         var n = deviceID.search(getDeviceID);
         if(n < 0)
         {
            if(deviceID != ''){
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {user_id:user_id},
                url: site_url+"administration/get_user_device",
                success: function(res){
                  console.log(res.device_id);
                  $("#form_edit textarea[name='deviceID']").val(res.device_id);
                }
              })
      ...
      $(".btn_device").click(function(){
         ...
         var conf = confirm('Apakah anda yakin untuk menjalankan aksi ini?');
          if(conf){
            $.ajax({
              type: "POST",
              url: site_url+"administration/set_device_list",
              dataType: "json",
              data: {val:val},
              success: function(response){
               location.reload();
