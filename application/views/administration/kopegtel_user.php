...
<div class="row-fluid">
   <div class="span12">
      ...
      <!-- BEGIN PAGE TITLE & BREADCRUMB-->
		<h3 class="page-title">
			User Kopegtel Setup <small>Pengaturan User Kopegtel</small>
		</h3>
		<ul class="breadcrumb">
			<li>
				<i class="icon-home"></i>
         ...
         <li><a href="#">User Administrator</a><i class="icon-angle-right"></i></li>  
			<li><a href="#">User Kopegtel Setup</a></li>	
		</ul>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>User Kopegtel</div>
      <div class="tools">
      ...
      <div class="portlet-body form">
         ...
         <form action="<?php echo site_url('administration/add_user'); ?>" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                 <input type="text" name="username" id="username" readonly="" style="background:#ddd;" data-required="1" class="medium m-wrap"/>
                 <div id="dialog_user" class="modal hide fade" tabindex="-1" data-width="500" style="margin-top:-200px;">
               ...
               <a id="browse_user" class="btn blue" data-toggle="modal" href="#dialog_user">...</a>
              </div>
            </div>  
            <div class="control-group">
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_edit" class="form-horizontal">
            ...
            <div class="control-group">
               <label class="control-label">Username<span class="required">*</span></label>
               <div class="controls">
                  <input type="text" name="username" readonly="" style="background:#ddd;" data-required="1" class="medium m-wrap"/>
...
// fungsi untuk mencari CIF_NO
      ...
      $("#keyword").keypress(function(e){
       if(e.which==13){
         $.ajax({
           type: "POST",
           url: site_url+"administration/search_username_kopegtel",
           ...
           success: function(response){
             ...
             for(i = 0 ; i < response.length ; i++){
               option += '<option value="'+response[i].kopegtel_code+'">'+response[i].kopegtel_code+' - '+response[i].nama_kopegtel+'</option>';
             }
             $("#result").html(option);
           }
         });
      ...
      $('#user_table').dataTable({
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": site_url+"administration/datatable_user_kopegtel_setup",
          "aoColumns": [
            null,
            null,
            null,
