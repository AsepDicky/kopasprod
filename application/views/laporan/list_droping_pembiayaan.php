   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if(cif_type==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_lap_droping_pembiayaan_individu/'+tanggal+'/'+tanggal2+'/'+cif_type+'/'+branch_code+'/'+petugas+'/'+produk+'/'+resort+'/'+akad+'/'+pengajuan_melalui);
        }else{
