...
/* BEGIN SCRIPT */
   ...
   $("#preview").click(function(e){
        ...
        window.open('<?php echo base_url();?>laporan_to_pdf/export_lap_lr_publish/'+branch_code+'/'+periode_bulan+'/'+periode_tahun);
   });
   ...
   $("#previewxls").click(function(e){
        ...
        var periode_bulan = $("#periode_bulan").val();
        var periode_tahun = $("#periode_tahun").val();
        window.open('<?php echo site_url();?>laporan_to_excel/export_lap_lr_publish/'+branch_code+'/'+periode_bulan+'/'+periode_tahun);
   });
