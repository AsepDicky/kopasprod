...
<script type="text/javascript">
                  ...
                  {               
                     ...
                     $.ajax({
                           ...
                           success: function(response){
                              ...
                              {
                                 html += '<option value="'+response[i].account_saving_no+'" attr_product_code="'+response[i].product_code+'">'+response[i].account_saving_no+'</option>';
                              }
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var produk = $("#no_rek option:selected").attr('attr_product_code');
        ...
        // }
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_list_rekening_tabungan/'+cif_no+'/'+no_rek+'/'+produk+'/'+tanggal+'/'+tanggal2);
        }
      });
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if (nama=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_list_rekening_tabungan/'+cif_no+'/'+no_rek+'/'+produk+'/'+tanggal+'/'+tanggal2);
        }
      });
