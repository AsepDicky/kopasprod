...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      CETAK TRANSAKSI KAS <small>modul untuk mencetak transaksi kas</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
        ...
        <i class="icon-angle-right"></i>
         ...
         <li><a href="#">KAS</a><i class="icon-angle-right"></i></li>  
      <li><a href="#">CETAK KAS</a></li>  
    </ul>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>CETAK KAS</div>
   </div>
...
<div id="print_voucher_area" style="display:none;font-size:10px;">
  ...
  <div style="border:solid 1px #000; padding:10px;">
	<div align="center">
      <h4 class="pa_voucher_type" style="font-weight:bold;">Surat Perintah Bayar (SPB) </span></h4>
    </div>
	<br>
    <table style="width:100%">
      <tr>
        <td valign="top" width="12%" style="font-size:12px;white-space:nowrap"><u>Catatan Bagian Asal</u> </td>
   <td width="12%">&nbsp;</td>
       

       <td style="white-space:nowrap;font-size:12px;width:12%">
          <u>Catatan di Bagian Anggaran : </u> </span>
        </td>
      </tr>
      </table>
      <table>
	   <tr>
        <td valign="top" width="10%" style="font-size:12px;white-space:nowrap">NOMOR</td>
        <td valign="top" width="5%" style="font-size:12px">:11/KU000/PK/2022</td>
        <td valign="top" style="font-size:12px"></td>
        <td width="5%">&nbsp;</td>
        <td style="white-space:nowrap;font-size:12px;width:35%">
          Lokasi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : Keuangan 
        </td>

      </tr>
           <tr>
        <td valign="top" width="10%" style="font-size:12px;white-space:nowrap">Tanggal</td>
        <td valign="top" width="5%" style="font-size:12px">:<span class="pa_printed_date"><?php echo date('d-m-Y'); ?></span></td>
      
        <td valign="top" style="font-size:12px"></td>
        <td width="5%">&nbsp;</td>
        <td style="white-space:nowrap;font-size:12px;width:35%">
          Beban / Tahun &nbsp;&nbsp;&nbsp;&nbsp; : Exploitasi / <del>Investasi 2020</del> 
        </td>
      </tr>
      <tr>
   
        <td valign="top" width="10%" style="font-size:12px;white-space:nowrap">TAHUN</td>
        <td valign="top" width="5%" style="font-size:12px">:<span class="pa_printed_date"><?php echo date('Y'); ?></span></td>
        <td valign="top" style="font-size:12px"></td>
        <td width="5%">&nbsp;</td>
        <td style="white-space:nowrap;font-size:12px;width:35%">
          No. MTP / Saldo &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Rp.  
...
<div align="center">
      <h4 class="pa_voucher_type" style="font-weight:bold;">PENGURUS / MANAGER</span></h4>
    </div>
	<div align="center">
      <h4 class="pa_voucher_type" style="font-weight:bold;">KOPERASI TELKOM (KOPTEL)</span></h4>
    </div>
     <table style="width:100%" id="pa_transaction2">
      <tr>
        <td valign="top" width="12%" style="font-size:12px;white-space:nowrap">Bendahara Koperasi PT Telekomunikasi Indonesia.Tbk di JL Ciwulan No 23 Bandung Diminta untuk membayarkan uang sebesar :
     ...
     <table style="width:100%" id="pa_transaction2">
        ...
        <td valign="top" width="1%" style="font-size:12px">Rp <span class="pa_amount" style="font-size:12px;"> </span> &nbsp;( <span class="pa_say_amount" style="font-size:12px;"></span> )</td>
        </table>
        <table>
        <tr><td width="5%">&nbsp;</td></tr>
    <tr><td valign="top" width="12%" style="font-size:12px;white-space:nowrap">Kepada :</td></tr>
    <tr>
    <td valign="top" width="12%" style="font-size:12px;white-space:nowrap">Nama / Alamat</td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">: Novita Wilasari Qoraag - Jl Ciwulan No 23 Bandung</td></tr>
    <tr><td valign="top" width="12%" style="font-size:12px;white-space:nowrap">Rekening</td>   <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">: Tunai</td></tr>
    <tr>
    <td valign="top" width="12%" style="font-size:12px;white-space:nowrap">Untuk</td>
     <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">: Reinburst Kas</td
      </tr>
        </td>
    ...
    <tr><td valign="top" width="30%" style="font-size:12px;white-space:nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bandung : <span class="pa_printed_date"><?php echo date('d-m-Y'); ?></span></td></tr>
    <tr>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mengetahui</td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">Mengetahui / Menyetujui</td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">Fiat Bayar</td></tr>
    <tr><td valign="top" width="40%" style="font-size:12px;white-space:nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sekretaris</td>   <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">KETUA</td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">Bendahara</td></tr>
   <tr>&nbsp;</tr>
   <tr>&nbsp;</tr>
   <tr>&nbsp;</tr>
   <tr>&nbsp;</tr>
    ...
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap"></td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap"></td 
     </tr>
    <tr>
    ...
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Iswan Elmy</td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">Ronaldi Amri</td>
    <td valign="top" width="40%" style="font-size:12px;white-space:nowrap">R Judy Darmadie</td 
     </tr>
    ...
    <table style="width:100%">
      <tr>
        <td valign="top" width="12%" style="font-size:12px;white-space:nowrap"><u>Catatan Pembayaran</u> </td>
   <td width="12%">&nbsp;</td>
    ...
    <table style="width:100%">
      <tr>
        <td valign="top" width="12%" style="font-size:12px;white-space:nowrap"><u>3. Catatan Peneriamaan :</u> </td>
     ...
     <tr>
        <td valign="top" width="10%" style="font-size:12px;white-space:nowrap">Telah Terima uang sebesar Rp. <span class="pa_amount" style="font-size:12px;"> </span> &nbsp;( <span class="pa_say_amount" style="font-size:12px;"></span> ) </td>

      </tr>
           <tr>
         <td valign="top" width="5%" style="font-size:12px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Bandung : <span class="pa_printed_date"><?php echo date('d-m-Y'); ?></span></td>
        <td valign="top" style="font-size:12px"></td>
        <td width="5%">&nbsp;</td>
   ...
   <tr>&nbsp;</tr>
    ...
    <div align="center">
      <h4 class="pa_voucher_type" style="font-weight:bold;">LAPORAN KAS</span></h4>
    </div>
    <br>
    <table style="width:100%" id="pa_transaction2">
      <tr>
        <td valign="top" width="12%" style="font-size:12px;white-space:nowrap">Nomor Voucher</td>
        <td valign="top" width="1%" style="font-size:12px">:Rp</td>
        <td class="print_nomor_voucher" style="font-size:12px">Rp</td>
    ...
    <table style="width:100%" id="pa_transaction">
      <thead>
        <tr>
		  ...
		  <th style="font-size:12px; border:solid 1px #AAA;">Deskripsi</th>
  ...
  <div align="center" style="padding:10px;">
    ...
    &nbsp;
	<button class="btn green" id="previewxls2">Cetak SPB</button>
    &nbsp;
...
$(function(){
   ...
   $("#keyword","#dialog_branch").keyup(function(e){
     ...
     $("a#previewxls2").live('click',function(){ 
        var id_spb = $(this).data('id_spb');
        window.open('<?php echo site_url();?>rekening_nasabah/do_cetak_spb_xls/'+id_spb+'/preview');
      });
    $("#previewxls3").click(function(e)
      {
        e.preventDefault();
       // var branch_code = $("#branch_code").val();
		
        window.open('<?php echo site_url();?>laporan_to_excel/export_lap_transaksi_tabungan_divisi2/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+jenis_transaksi);
        // window.open('<?php echo site_url();?>laporan_to_excel/export_lap_transaksi_tabungan/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code+'/'+jenis_transaksi);
      });
...
$("a#btn-cetakvoucher").live('click',function(){
    ...
    // }else{
      ...
      $.ajax({
        ...
        //  $(".pa_say_amount","#print_voucher_area").text(terbilang(parseFloat(total_debit).toString())+' rupiah');
        ...
        <td style="font-size:12px; padding:5px;border-bottom:solid 1px #AAA;border-right:solid 1px #AAA;">'+trx_gl_detail[i].description+'</td> \
          ...
          tbody += '<tr> \
            <td style="font-size:12px; font-weight:bold;padding:5px;border-bottom:solid 1px #AAA;border-right:solid 1px #AAA;border-left:solid 1px #AAA;" align="right" colspan="4">Total</td> \
          ...
          $(".pa_say_amount","#print_voucher_area").text(terbilang(parseFloat(total_debit).toString())+' rupiah');
           $(".pa_amount","#print_voucher_area").text(number_format(total_debit,2,',','.'));
        }
      })
  ...
  $("a#btn-cetakvouchers").live('click',function(){
    // n = 0;
    // $("input#checkbox:checked").each(function(){
    //   n++;
    // });
