...
<br>
  <div style="font-size:11px;width:610px;padding-top:10px;text-align:justify;text-justify:inter-word;">
    ...
    <table>
      ...
      <tr>
        <td>c.</td>
        <td><div style="width:580px;">bahwa sesuai dengan Surat Edaran No. 28/YAN-000/PK/2011 tanggal 24 Januari 2011 tentang Penetapan Suku Bunga, Jangka Waktu dan Biaya Administrasi Pemberian Pinjaman Kredit Pemilikan Rumah, bahwa salah satu bentuk pengembangan KOPTEL adalah memberikan Pembiayaan Kredit Pemilikan Rumah (KPR) bagi karyawan PT. Telkom yang memerlukan rumah yang dibangun oleh developer atau pembelian langsung dari penjual  dengan lokasi di perumahan / daerah premium atau take over KPR dari bank atau Pembiayaan untuk renovasi rumah dengan jaminan atau peningkatan (Top Up) jumlah KPR, sepanjang Cash Flow KOPTEL masih tersedia.</div></td>
      </tr>
    </table>
  </div>
<br>
  ...
  <table style="font-size:11px;">
    ...
    <tr>
      ...
      <td>: <strong>Kredit Pemilikan Rumah (KPR)</strong></td>
    </tr>
    <tr>
      <td>2.</td>
...
<br>
  ...
  <table>
    <tr>
      ...
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;">
          PIHAK KEDUA akan membayar Angsuran paling lambat tanggal 25 (dua puluh lima) untuk setiap bulan terhitung bulan <?php echo $array_bulan[(int)date('m',strtotime($cetak['tanggal_mulai_angsur']))] ?> <?php echo date('Y',strtotime($cetak['tanggal_akad']));?> kepada PIHAK PERTAMA yang besarnya sebagaimana dimaksud dalam lampiran Pasal 1 di atas;
        </div>
      </td>
    </tr>
    <tr>
        ...
        <div style="float:left;width:570px;text-align:justify;">
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                  <div style="float:left;width:530px;">
                  Hasil dari penjualan tersebut akan dibayarkan kepada PIHAK KEDUA setelah dipotong saldo Pembiayaan ditambah margin dan biaya-biaya lain yang ditimbulkannya;
                  </div>
              </td>
            </tr>
          </table>
  ...
  <table>
    ...
    <tr>
      <td style="width:20px;font-size:11px;" colspan="2" align="right">(8) PIHAK....</td>
    </tr>
  </table>
</div>
</page>
...
<div style="margin-left:70px;width:610px;">
  <table align="center">
    <tr>
      <td colspan="3" align="center">JADWAL ANGSURAN <br>KPR KOPTEL<br><br>&nbsp;</td>
    </tr>
    <tr>
      <td>NAMA KONSUMEN</td>
      <td>:</td>
...
<page>
<div  style="margin-left:70px;width:610px;">
  <div style="font-size:11.5px;width:610px;padding-top:15px;text-align:justify;text-justify:inter-word;line-height:15px;">
    <?php if($cetak['akad_no']=='0'){ ?>
      <br>Nomor  : <?php echo $cetak['product_code'].$cetak['registration_no'];?>/<?php echo $seri_surat;?>/<?php echo date("Y");?>
    <?php }else{?>
      <br>Nomor  : <?php echo $cetak['product_code'].$cetak['akad_no'];?>/<?php echo $seri_surat;?>/<?php echo date("Y");?>
    <?php }?>
    <br>
    Bandung, <?php echo $array_bulan[(int)date('m',strtotime($cetak['tanggal_akad']))] ?> <?php echo date('Y',strtotime($cetak['tanggal_akad']));?>
    <br><br><br>

    Kepada Yth.
    <br>Notaris / PPAT Nining Puspitaningtyas, SH
    <br>Jl. Palasari No. 29a
    <br>Bandung

    <br><br><br>
    Perihal : Pemasangan Hak Tanggungan atas Jaminan 
    <br>Atas Nama <?php if($data_jaminan['atas_nama']) echo strtoupper($data_jaminan['atas_nama']) ;?>.

    <br><br><br>
    Dengan ini kami mohon bantuan Saudara untuk melaksanakan Pengikatan Hak Tanggungan senilai Rp. <?php echo number_format(($cetak['pokok']*1.3));?>,- (<?php echo Terbilang(($cetak['pokok']*1.3));?>) dengan jumlah pembiayaan sebesar Rp. <?php echo number_format($cetak['pokok']);?> (<?php echo Terbilang($cetak['pokok']);?>) atas tanah seluas <?php if($data_jaminan['luas_tanah']) echo $data_jaminan['luas_tanah'].' m2  ('.Terbilang($data_jaminan['luas_tanah']).' meter persegi)' ;?> sebagaimana dimaksud dalam Sertipikat Hak Milik No. <?php if($data_jaminan['nomor_jaminan']) echo $data_jaminan['nomor_jaminan'];?>, terletak di Propinsi <?php if($data_jaminan['province']) echo $data_jaminan['province'];?> <?php if($data_jaminan['city']) echo $data_jaminan['city'];?> <?php if($data_jaminan['kecamatan']) echo $data_jaminan['kecamatan'];?>  <?php if($data_jaminan['kelurahan']) echo $data_jaminan['kelurahan'];?>  atas nama <?php if($data_jaminan['atas_nama'])echo $data_jaminan['atas_nama'];?> yang berlokasi di <?php if($data_jaminan['kelurahan'])echo 'Kelurahan '.$data_jaminan['kelurahan'];?> <?php if($data_jaminan['blok'])echo $data_jaminan['blok'];?> serta Bangunan Rumah yang berdiri diatasnya atas Jaminan Pembiayaan atas nama <?php if($data_jaminan['atas_nama'])echo strtoupper($data_jaminan['atas_nama']);?>.
    <br><br>
    Pengikatan tersebut di atas adalah untuk menjamin Pembiayaan berdasarkan Perjanjian Pembiayaan yang telah ditandatangani dihadapan Saudara.
    <br><br>
    Sehubungan dengan hal tersebut kami harapkan Saudara menerbitkan Cover Note yang ditujukan kepada Koperasi PT. Telekomunikasi Indonesia (KOPTEL) yang menyatakan bahwa atas jaminan telah dilaksanakan pengecekan ke Kantor Pertanahan dan persyaratan dalam rangka pengurusan Hak Tanggungan telah lengkap serta tanggal kesanggupan Saudara untuk menyelesaikan pengikatan tersebut.
    <br><br>
    Apabila pengurusan atas Pengikatan atas Hak Tanggungan telah selesai hanya akan diserahkan kepada Koperasi PT. Telekomunikasi Indonesia (KOPTEL). Atas semua biaya yang timbul sehubungan dengan pengikatan tersebut dapat Saudara tagihkan melalui kami.
    <br><br>
    Demikian agar maklum dan atas bantuan serta kerjasama Saudara, kami ucapkan terima kasih.
    <br><br><br><br>
    <strong>an. PENGURUS KOPTEL
...
<div  style="margin-left:70px;width:610px;">
  <div style="font-size:11.5px;width:610px;padding-top:15px;text-align:justify;text-justify:inter-word;line-height:15px;">
    <div style="text-decoration:underline;font-size:20px;text-align:center">SURAT PERNYATAAN</div>
    <br><br><br>
    ...
    <table>
      <tr>
        <td>Nama / NIK</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;"><?php echo $cetak['nama'].' / '.$cetak['cif_no'];?></div></td>
      </tr>
      <tr>
        <td>Alamat</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;"><?php echo $cetak['alamat'];?></div></td>
      </tr>
      <tr>
        <td>Lokasi Kerja</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;">Karyawan PT. Telkom <br><?php echo $cetak['loker'];?><br><?php echo $cetak['code_divisi'];?></div></td>
      </tr>
      <tr>
        <td>Alamat Lokasi Kerja</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;"></div></td>
      </tr>
    </table>
    ...
    <br><br>
    Pengambilan Berkas Jaminan di PT. Bank Negara Indonesia (PERSERO) Tbk. akan diserahkan ke KOPTEL pada kesempatan pertama untuk kemudian dijadikan Jaminan sebagaimana dimaksud dalam Perjanjian Pembiayaan  
    <?php if($cetak['akad_no']=='0'){ ?>
      &nbsp;Nomor  : <?php echo $cetak['product_code'].$cetak['registration_no'];?>/<?php echo $seri_surat;?>/<?php echo date("Y");?>
    <?php }else{?>
      &nbsp;Nomor  : <?php echo $cetak['product_code'].$cetak['akad_no'];?>/<?php echo $seri_surat;?>/<?php echo date("Y");?>
    <?php }?> tanggal  <?php echo date('d',strtotime($cetak['tanggal_akad']));?> <?php echo $array_bulan[(int)date('m',strtotime($cetak['tanggal_akad']))] ?> <?php echo date('Y',strtotime($cetak['tanggal_akad']));?>
    <br><br>
    ...
    <br><br><br><br>
    <strong>
      <div style="text-align:left;text-decoration:underline;"><?php echo $cetak['nama'];?></div>
      <div style="text-align:left"><?php echo $cetak['cif_no'];?></div>
    </strong>
  </div>
  <br>
</div>
...
<div  style="margin-left:70px;width:610px;">
  <div style="font-size:11.5px;width:610px;padding-top:15px;text-align:justify;text-justify:inter-word;line-height:15px;">
    <div style="font-size:20px;text-align:center">BISMILLAHIRRAHMAANIRRAHIM</div>
    <br><div style="text-decoration:underline;font-size:20px;text-align:center">SURAT PERNYATAAN</div>
    <br><br><br>
    ...
    <table>
      ...
      <tr>
        <td>Band Posisi</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;"><?php echo $cetak['band'];?></div></td>
      </tr>
      <tr>
        <td>No KTP</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;"><?php echo $cetak['no_ktp'];?></div></td>
      </tr>
      <tr>
        <td>Jabatan</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;"><?php echo $cetak['posisi'];?></div></td>
      </tr>
      <tr>
        <td>Lokasi Kerja</td>
        <td>:</td>
        <td><div style="width:500px;;text-align:justify;text-justify:inter-word;"><?php echo $cetak['loker'];?></div></td>
      </tr>
      <tr>
        <td>Alamat Lokasi Kerja</td>
        <td>:</td>
    ...
    Dengan ini menyatakan bahwa :
    <br><br>
    Dengan ini menyatakan bahwa, Pembiayaan KPR yang saya terima, berdasarkan Lampiran Perjanjian Pembiayaan <?php if($cetak['akad_no']=='0'){ ?>
      &nbsp;Nomor  : <?php echo $cetak['product_code'].$cetak['registration_no'];?>/<?php echo $seri_surat;?>/<?php echo date("Y");?>
    <?php }else{?>
      &nbsp;Nomor  : <?php echo $cetak['product_code'].$cetak['akad_no'];?>/<?php echo $seri_surat;?>/<?php echo date("Y");?>
    <?php }?>  tanggal  <?php echo date('d',strtotime($cetak['tanggal_akad']));?> <?php echo $array_bulan[(int)date('m',strtotime($cetak['tanggal_akad']))] ?> <?php echo date('Y',strtotime($cetak['tanggal_akad']));?> 
    sebesar Rp. <?php echo number_format($cetak['pokok']);?> (<?php echo Terbilang($cetak['pokok']);?>) adalah benar saya pergunakan untuk Take Over dari Bank Negara Indonesia.
    <br><br>
    Demikian Surat Pernyataan ini saya buat dengan sebenarnya dan untuk dipergunakan sebagai bukti kelengkapan dokumen pembiayaan.
    <br><br><br><br>
    Bandung, <?php echo $array_bulan[(int)date('m',strtotime($cetak['tanggal_akad']))] ?> <?php echo date('Y',strtotime($cetak['tanggal_akad']));?>
    <br><br><br><br>
    <div style="font-size:9px;">Materi Rp. 6.000,-</div>
    <br><br><br><br>
    <strong>
      <div style="text-align:left;text-decoration:underline;"><?php echo $cetak['nama'];?></div>
      <div style="text-align:left"><?php echo $cetak['cif_no'];?></div>
