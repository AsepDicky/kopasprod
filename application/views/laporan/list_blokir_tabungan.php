...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Blokir Tabungan</div>
      <div class="tools">
      ...
      <div class="clearfix">
            <!-- BEGIN FILTER-->
              ...
              <tr>
                 ...
                 <tr>
                    <td style="padding-bottom:10px;" width="100">Tanggal Blokir</td>
                    <td>
    ...
    $("#select_cabang").trigger('click');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if (tanggal=="" && tanggal2=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_list_blokir_tabungan/'+tanggal+'/'+tanggal2+'/'+cabang);
        }
      });
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if (tanggal=="" && tanggal2=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_list_blokir_tabungan/'+tanggal+'/'+tanggal2+'/'+cabang);
        }
      });
