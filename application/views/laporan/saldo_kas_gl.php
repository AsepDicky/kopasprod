   ...
   <table width="100%" border="1" bordercolor="#CCC" cellpadding="5" id="general_ledger">
      <thead>
         <tr>
            ...
            <th style="background:#EEE;" width="15%">Proyeksi</th>
         </tr>
      </thead>
      <tbody>
         <tr>
...
/* BEGIN SCRIPT */
   ...
   $("#previewpdf").click(function(e){
      ...
      if(periode_bulan==""){
        ...
        window.open(site_url+"laporan_to_pdf/neraca_saldo_gl/"+periode_bulan+"/"+periode_tahun+"/"+branch_code);
      }
   });
   $("#previewxls").click(function(e){
      ...
      if(periode_bulan==""){
        ...
        window.open(site_url+"laporan_to_excel/neraca_saldo_gl/"+periode_bulan+"/"+periode_tahun+"/"+branch_code);
      }
   });
