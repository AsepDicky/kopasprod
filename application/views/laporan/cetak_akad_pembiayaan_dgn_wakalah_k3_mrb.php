...
<div style="margin-left:30px;width:610px;font-size:11px !important;">
  ...
  <table cellspacing="0" cellpadding="0" style="text-align:justify;line-height:20px;margin-top:10px;width:610px;">
    <tr>
    ...
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          ...
          <table>
            <tr>
              <td valign="top">a. Angsuran pokok sebesar </td>
              <td valign="top">: Rp. <?php echo number_format($angsuran_pokok,2,",",".");?></td>
            </tr>
            <tr>
              <td valign="top">b. Angsuran margin sebesar</td>
              <td valign="top">: Rp. <?php echo number_format($angsuran_margin,2,",",".");?></td>
            </tr>
            <tr>
              <td valign="top">c. Angsuran cadangan tabungan</td>
              <td valign="top">: Rp. <?php echo number_format($angsuran_catab,2,",",".");?></td>
            </tr>
          </table>
        </div>
      </td>
    ...
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          ...
          <table>
            <tr>
              <td valign="top">a. Biaya administrasi </td>
              <td valign="top">: Rp. <?php echo number_format($Nominalbiaya_administrasi,2,",",".");?></td>
            </tr>
            <tr>
              <td valign="top">b. Biaya Jasa Layanan </td>
              <td valign="top">: Rp. <?php echo number_format($Nominalbiaya_jasa_layanan,2,",",".");?></td>
            </tr>
            <tr>
              <td valign="top">c. Simpanan Wajib Pinjam </td>
              <td valign="top">: Rp. <?php echo number_format($Nominalsimpanan_wajib_pinjam,2,",",".");?></td>
            </tr>
          </table>
        </div>
      </td>
  ...
  <div style="text-align:justify;line-height:20px;margin-top:30px;width:610px;">
