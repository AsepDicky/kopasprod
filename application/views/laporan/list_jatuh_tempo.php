...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Jatuh Tempo</div>
      <div class="tools">
   ...
   /* END RESORT */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if(branch_code==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_list_jatuh_tempo/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+petugas+'/'+produk+'/'+akad+'/'+pengajuan_melalui);
        }
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if(branch_code==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_list_jatuh_tempo/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+petugas+'/'+produk+'/'+akad+'/'+pengajuan_melalui);
        }
      });
