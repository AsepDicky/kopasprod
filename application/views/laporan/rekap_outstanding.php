...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Outstanding Deposito</div>
      <div class="tools">
            ...
            <table id="filter-form">
               ...
               <tr id="field_rembug">
                 ...
                 <tr>
                    ...
                    <td>
                      <select name="produk" id="produk" style="width:170px;" class="medium m-wrap">
...
/* BEGIN DIALOG ACTION BRANCH */
   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if(branch_code==""){
          alert("Mohon pilih Cabang dan Rembug Terlebih Dahulu");
        }else if(produk==""){
          alert("Mohon pilih Produk Terlebih Dahulu");
        }else{
          window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_outstanding_deposito/'+produk+'/'+branch_code+'/'+cm_code);
        }
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if(branch_code==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_outstanding_deposito/'+produk+'/'+branch_code+'/'+cm_code);
        }
      });
