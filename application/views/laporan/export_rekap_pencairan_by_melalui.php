...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:18px;">
        Rekap Pencairan Pembiayaan Berdasarkan Pengajuan Melalui
        </div>
  ...
  <table id="hor-minimalist-b" align="center" style="margin:0;">
    <tbody>
      <tr>
            <td class="no" style="width:50px;">NO</td>
            <td class="anggota" style="width:150px;">Keterangan</td>
            <td class="jumlah" style="width:70px;">Jumlah</td>
      ...
      <tr class="value">
            ...
            <td class="val_anggota" style="text-align:left;"><?php echo $data['pengajuan_melalui'];?></td>
