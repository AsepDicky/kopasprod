...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:16px;">
        Rekap Pengajuan Pembiayaan Berdasarkan Resort
        </div>
...
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
            <td class="no" style="width:120px;">NO</td>
            <td class="anggota" style="width:180px;">Keterangan</td>
            <td class="jumlah" style="width:130px;">Jumlah</td>
            <td class="pokok" style="width:130px;">Nominal</td>
      </tr>
      <?php
      $no = 1; 
      $total_anggota = 0;
      ...
      ?>
      <tr class="value">
            <td class="val_anggota" style="padding:2px;"><?php echo $no++;?></td>
            <td class="val_anggota" style="padding:2px;"><?php echo $data['resort_name'];?></td>
            <td class="val_jumlah" style="padding:2px;"><?php echo $data['num'];?></td>
            <td class="val_pokok" style="padding:2px;"><?php echo number_format($data['amount'],0,',','.');?></td>
      </tr>
    <?php 
        endforeach;
    ?>      
      <tr class="value">
            ...
            <td class="val_jumlah" style="padding:2px;"><?php echo $total_anggota;?></td>
            <td class="val_pokok" style="padding:2px;"><?php echo number_format($total_pokok,0,',','.');?></td>
      </tr>
    </tbody>
</table>
</page>