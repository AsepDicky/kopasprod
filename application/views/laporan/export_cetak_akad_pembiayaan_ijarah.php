...
<div style="margin-left:70px;width:610px;">
  ...
  <div align="center" style="font-size:12px;width:610px;padding-bottom:7px;border-bottom:1px solid #000;">
    PERJANJIAN PEMBERIAN PEMBIAYAAN IJARAH  
    <br>ANTARA
  ...
  <div style="font-size:11px;width:610px;padding-top:15px;text-align:justify;text-justify:inter-word;">
    <table>
      <tr>
        ...
        <td colspan="2"><?php if (strtolower($cetak['pengajuan_melalui'])=='koptel'){ ?><strong><?php echo $institution['institution_name'];?></strong> <?php }else{?> <strong> <?php echo strtoupper($cetak['nama_kopegtel']);?></strong> <?php }?>, yang diwakili oleh :</td>
      </tr>
      <tr>
        <td></td>
        <td>Nama / NIK.</td>
        <td>: <?php if(isset($pejabat_nama)) echo $pejabat_nama; if(isset($pejabat_nik)) echo ' / '.$pejabat_nik;?>.</td>
      </tr>
      <tr>
        <td></td>
        <td>Jabatan </td>
        <td>: <?php if(isset($pejabat_jabatan)) echo $pejabat_jabatan;?></td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        <td></td>
        <td colspan="2">Selanjutnya dalam perjanjian ini disebut sebagai <strong>PIHAK KEDUA</strong> atau <strong>PIHAK PENYEWA/PENGGUNA JASA</strong>.</td>
      </tr>
    </table>
  </div>
  ...
  <table>
    <tr>
      ...
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;text-justify:inter-word;line-height:15px;" >PIHAK PERTAMA akan membayarkan sejumlah dana atas pembelian barang pada PIHAK KETIGA dan atau menguasakan pada PIHAK KEDUA untuk membeli sendiri dengan menyerahkan uang tunai sebesar Rp <?php echo number_format($pokok);?> untuk <?php echo strtoupper($cetak['display_text']);?> </div>
      </td>
    </tr>
    <tr>
      <td style="width:20px;font-size:11px;">(2)</td>
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;text-justify:inter-word;line-height:15px;" >PIHAK PERTAMA akan membayarkan sejumlah dana  untuk menyewa manfaat <?php echo strtoupper($cetak['display_text']);?> dari PIHAK KETIGA  dan atau menguasakan pada PIHAK KEDUA untuk membayarkan biayasewa barang/jasa tersebut dengan menyerahkan uang tunai sebesar Rp <?php echo number_format($pokok);?> untuk <?php echo strtoupper($cetak['display_text']);?> </div>
      </td>
    </tr>
    <tr>
      <td style="width:20px;font-size:11px;">(3)</td>
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;text-justify:inter-word;line-height:15px;" >PIHAK PERTAMA kemudian menyewakan kembali brang/jasa tersebut diatas kepada PIHAK KEDUA dengan  margin sewa  bagi PIHAK PERTAMA sebesar Rp <?php echo number_format($margin);?>, sehingga nilai sewa seluruhnya sebesar Rp. <?php echo number_format($totalhutang);?> </div>
      </td>
    </tr>
    <tr>
      <td style="width:20px;font-size:11px;">(4)</td>
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;text-justify:inter-word;line-height:15px;" >Pihak kedua sanggup membayar hingga lunas hutang tersebut kepada PIHAKERTAMA  dengan mengangsur selama <?php echo $cetak['jangka_waktu'];?> <?php echo $periode_jangka_waktu;?> sebesar <?php echo number_format($totalangsuran);?> / <?php echo $periode_jangka_waktu;?> mulai tanggal <?php echo date("d-m-Y", strtotime($cetak['tanggal_mulai_angsur']));?> dengan rincian sebagai berikut : 
          <br>
          <table>
            <tr>
              <td>a.</td>
    ...
    <tr>
      ...
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;text-justify:inter-word;line-height:15px;">Terhadap fasilitas pembiayaan ini, PIHAK KEDUA bersedia menyerahkan uang sejumlah <?php echo number_format($biaya_administrasi);?> untuk pembayaran :  
          <br>
          <table>
            <tr>
              <td>a.</td>
  ...
  <table>
    <tr>
      <td style="width:20px;font-size:11px;">(1)</td>
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;text-justify:inter-word;line-height:15px;">
