...
<page>
      <div style="width:100%;">
        ...
        <!-- <div style="text-align:left;padding-top:5px;font-family:Arial;font-size:13px;">
          Tanggal : <?php echo $CI->format_date_detail($tanggal,'id',true,' ')?>
        </div> -->
        <hr>
      </div>
      <br>
    ...
    <tbody>
      <tr>
            <td style="text-align:center; font-size:9px; padding:5px; border:solid 1px #555; width:7px;" rowspan="2">No.</td>
            ...
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right: solid 1px #555; border-top:solid 1px #555;" rowspan="2">Freq.<br>Bayar</td>
            ...
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right: solid 1px #555; border-top:solid 1px #555;" rowspan="2">Jatuh Tempo</td>
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right: solid 1px #555; border-top:solid 1px #555;" rowspan="2">Besar Angsur</td>
            <!-- <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right: solid 1px #555; border-top:solid 1px #555;" rowspan="2">Petugas</td> -->
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right: solid 1px #555; border-top:solid 1px #555;" rowspan="2">Produk</td>
      </tr>
      <tr>
            ...
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right:solid 1px #555; width:80px;">Nama</td>
            ...
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right:solid 1px #555; width:45px;">Pokok</td>
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right:solid 1px #555; width:45px;">Margin</td>
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right:solid 1px #555; width:10px;">Freq.</td>
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right:solid 1px #555; width:45px;">Pokok</td>
            <td style="text-align:center; font-size:9px; padding:5px; border-bottom:solid 1px #555; border-right:solid 1px #555; width:45px;">Margin</td>
      </tr>
      <?php 
        ...
        $tunggakan_pokok      = $data['freq_tunggakan']*$data['angsuran_pokok'];
        $tunggakan_margin     = $data['freq_tunggakan']*$data['angsuran_margin'];
      ...
      <tr>
            ...
            <td style="padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;width:60px"><?php echo $data['nama'];?></td>
            ...
            <td style="padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"><?php echo $data['saldo_freq_bayar'];?></td>
            ...
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"><?php echo number_format($tunggakan_pokok,0,',','.');?></td>
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"><?php echo number_format($tunggakan_margin,0,',','.');?></td>
            <!-- <td style="padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"><?php echo $data['status_kolektibilitas'];?></td> -->
            <td style="text-align:center; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"><?php echo $CI->format_date_detail($data['tanggal_jtempo'],'id',false,'-');?></td>
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"><?php echo number_format($data['besar_angsuran'],0,',','.');?></td>
            <!-- <td style="padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;width:60px;"><?php echo $data['fa_name']; ?></td> -->
            <td style="padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"><?php echo $data['product_name']; ?></td>
      </tr>
    <?php endforeach?>    
      <tr>
            ...
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"></td>
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555; font-weight: bold;"><?php echo number_format($total_tunggakan_pokok,0,',','.');?></td>
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555; font-weight: bold;"><?php echo number_format($total_tunggakan_margin,0,',','.');?></td>
            <!-- <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"></td> -->
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"></td>
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"></td>
            <td style="text-align:right; padding:5px; font-size:8px; border-bottom: solid 1px #555; border-right: solid 1px #555;"></td>
