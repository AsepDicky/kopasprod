  ...
  <div class="portlet-body form">
     ...
     <form action="#" method="post" enctype="multipart/form-data" id="form_add" class="form-horizontal">
        ...
        <div class="control-group">
           ...
           <div class="controls">
            <input type="text" name="cm_name" id="cm_name" class="medium m-wrap" readonly style="background:#EEE;">
...
$("#export_excel").click(function(e){
  ...
  cm_code = $("#cm_code").val();
  window.open(site_url+"laporan_to_excel/export_list_saldo_tabungan/"+branch_code+"/"+cm_code);
});
...
$("#export_pdf").click(function(e){
  ...
  branch_code = $("#branch_code").val();
  cm_code = $("#cm_code").val();
  window.open(site_url+"laporan_to_pdf/export_list_saldo_tabungan/"+branch_code+"/"+cm_code);
});
