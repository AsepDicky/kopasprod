...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Transaksi Tabungan</div>
      <div class="tools">
      ...
      <div class="clearfix">
         ...
         <form>
            ...
            <table id="filter-form">
               ...
               <tr>
                  <td width="100" valign="top">Jenis Transaksi</td>
                  <td valign="top">
                    <select name="jenis_transaksi" id="jenis_transaksi" class="m-wrap">
                    <!--  <option value="">Pilih</option>
                      <option value="">Semua</option>
                      <option value="1">Setoran Tunai</option>-->
                      <option value="2">RESTITUSI TWP</option>
                  <!--    <option value="3">Pemindahbukuan Keluar</option>
                      <option value="4">Pemindahbukuan Masuk</option>-->
                    </select>
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <button class="green btn" id="previewxls">Lampiran</button>
                     <button class="green btn" id="previewxls2"> SPB</button>
                  </td>
               </tr>
            </table>
         </form>
...
/* BEGIN DIALOG ACTION BRANCH */
   ...
   $("#select","#dialog_branch").click(function(){
      ...
      if(result!=null)
      {
         ...
         // $("#field_rembug").show();
         $("#field_rembug").hide(); //dihide karena khusus tam tidak ada kelompok
   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_excel/export_lap_transaksi_tabungan_divisi/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+jenis_transaksi);
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var tanggal = datepicker_replace($("#tanggal").val());
        var tanggal2 = datepicker_replace($("#tanggal2").val());
        window.open('<?php echo site_url();?>laporan_to_pdf/export_lap_transaksi_tabungan_divisi/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+jenis_transaksi);
        // window.open('<?php echo site_url();?>laporan_to_pdf/export_lap_transaksi_tabungan/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code+'/'+jenis_transaksi);
      });
