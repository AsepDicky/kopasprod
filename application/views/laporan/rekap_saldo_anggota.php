        ...
        var cabang = $("#cabang").val();
          if (filter=='0'){            
              if(cabang=='0000' || cabang==''){            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_saldo_anggota_semua_cabang/'+cabang);
              }else{            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_saldo_anggota_cabang/'+cabang);
              } 
          }else if (filter=='1'){
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_saldo_anggota_rembug/'+cabang);
          }else if (filter=='2'){
