...
<div style="margin-left:70px;width:610px;">
  ...
  <br>
  <br>
  <div style="text-align:justify;line-height:20px;font-size:13px;margin-top:30px;width:610px;margin-left:75px;">
  ...
  <div style="width:610px;margin-top:30px;font-size:13px;margin-left:75px;">
    <table>
      <tr>
