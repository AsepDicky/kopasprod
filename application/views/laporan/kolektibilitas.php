          ...
          <table id="filter-form">
             ...
             <tr>
                ...
                <td>
                   ...
                   <button class="green btn" id="preview_xls">Preview Excel</button>
                </td>
             </tr>
          </table>
       <!-- END FILTER FORM -->
...
/* BEGIN SCRIPT */
   ...
   $("#preview_pdf").click(function(e){
      ...
      window.open('<?php echo site_url();?>laporan_to_pdf/export_rekapitulasi_npl/'+branch_code);
   });

   $("#preview_xls").click(function(e){
      e.preventDefault();
      var branch_code = $("#branch_code").val();
      window.open('<?php echo site_url();?>laporan_to_excel/export_rekapitulasi_npl/'+branch_code);
   });
