    ...
    $("#select_cabang").trigger('click');
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_list_pembukaan_tabungan/'+produk+'/'+cabang);
        }
      });
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_list_pembukaan_tabungan/'+produk+'/'+cabang);
        }
      });
      ...
      $("#previewcsv").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_csv/export_list_pembukaan_tabungan/'+produk+'/'+cabang);
        }
      });
