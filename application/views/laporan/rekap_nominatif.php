   ...
   <form>
      ...
      <table id="filter-form">
         ...
         <tr>
            ...
            <td>
               <input type="text" id="from_date" name="from_date" class="m-wrap small date-picker mask_date" value="<?php echo date('d/m/Y') ?>">
               <span style="line-height:35px;">S/D&nbsp;</span>
               <input type="text" id="thru_date" name="thru_date" class="m-wrap small date-picker mask_date" value="<?php echo date('d/m/Y') ?>">
            </td>
         </tr>
         <tr>
            <td></td>
...
/* BEGIN SCRIPT */
   ...
   $("#previewxls").click(function(e){
        ...
        var from_date = $("#from_date").val().replace(/\_/g,'').replace(/\//g,'');
        var thru_date = $("#thru_date").val().replace(/\_/g,'').replace(/\//g,'');
        window.open('<?php echo site_url();?>excel/rekap_nominatif/'+branch_code+'/'+from_date+'/'+thru_date);
   });
