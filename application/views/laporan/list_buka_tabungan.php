...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Pembukaan Tabungan</div>
      <div class="tools">
...
<script type="text/javascript">
  ...
  $("#previewpdf").click(function(e)
  {
    ...
    if (produk=="") {
      ...
      window.open('<?php echo site_url();?>laporan_to_pdf/export_list_buka_tabungan/'+produk+'/'+tanggal+'/'+tanggal2+'/'+cabang);
    }
  });
  ...
  $("#previewxls").click(function(e)
  {
    ...
    if (produk=="") {
      ...
      window.open('<?php echo site_url();?>laporan_to_excel/export_list_buka_tabungan/'+produk+'/'+tanggal+'/'+tanggal2+'/'+cabang);
    }
  });
