...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Proyeksi Restitusi Tabungan</div>
      <div class="tools">
      ...
      <div class="clearfix">
            <!-- BEGIN FILTER-->
              <table id="sorting_saldo">
                 ...
                 <tr>
                    <td style="padding-bottom:10px;" width="200">Tanggal Pembukaan</td>
                    <td>
...
<script type="text/javascript">
  ...
  $("#previewpdf").click(function(e)
  {
    ...
    if (produk=="") {
      ...
      window.open('<?php echo site_url();?>laporan_to_pdf/export_list_proyeksi_tabungan/'+produk+'/'+tanggal+'/'+tanggal2+'/'+cabang);
    }
  });
  ...
  $("#previewxls").click(function(e)
  {
    ...
    if (produk=="") {
      ...
      window.open('<?php echo site_url();?>laporan_to_excel/export_list_proyeksi_tabungan/'+produk+'/'+tanggal+'/'+tanggal2+'/'+cabang);
    }
  });
