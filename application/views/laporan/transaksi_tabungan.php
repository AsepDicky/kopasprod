      ...
      <div class="clearfix">
         ...
         <form>
            ...
            <table id="filter-form">
               ...
               <tr id="field_rembug">
                  <td style="padding-bottom:10px;" width="100">Rembugs</td>
                  <td>
               ...
               <tr>
                  ...
                  <td valign="top">
                    <select name="jenis_transaksi" id="jenis_transaksi" class="m-wrap">
                      ...
                      <option value="3">Restitusi TWP</option>
...
/* BEGIN DIALOG ACTION BRANCH */
   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_excel/export_lap_transaksi_tabungan/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+jenis_transaksi);
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var tanggal = datepicker_replace($("#tanggal").val());
        var tanggal2 = datepicker_replace($("#tanggal2").val());
        window.open('<?php echo site_url();?>laporan_to_pdf/export_lap_transaksi_tabungan/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+jenis_transaksi);
