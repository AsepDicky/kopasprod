...
<div style="margin-left:70px;width:610px;">
  ...
  <div align="center" style="font-size:11px;width:610px;padding-top:7px;">
    Nomor : <?php echo $cetak['product_code'].$cetak['registration_no'];?>/HK410/POB/<?php echo date("Y");?>
  </div>
<br>
...
<br>
  ...
  <table>
    ...
    <tr>
      ...
      <td style="font-size:11px;">
        <div style="float:left;width:570px;text-align:justify;text-justify:inter-word;line-height:14px;" >
          Pihak kedua sanggup membayar hingga lunas hutang tersebut kepada PIHAKERTAMA  dengan mengangsur selama <?php echo $cetak['jangka_waktu'];?> <?php echo $periode_jangka_waktu;?> sebesar <?php echo number_format($totalangsuran);?> / <?php echo $periode_jangka_waktu;?> yang jatuh tempo setiap tanggal 25, mulai bulan  <?php echo $array_bulan[(int)date('m',strtotime($cetak['tanggal_mulai_angsur']))] ?> <!--  dengan rincian sebagai berikut :  -->
          <br>
          <!-- <table>
            <tr>
              <td>a.</td>
