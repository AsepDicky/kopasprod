...
<div style="margin-left:30px;width:610px;font-size:11px !important;">
  ...
  <div style=";line-height:20px;width:610px;">
            ...
            <table cellspacing="0" cellpadding="0">
              <tbody>
                ...
                <tr>
                  ...
                  <td><div width="380" style="padding:3px 0;line-height:20px;">: &nbsp;BANDUNG<?php echo $institution['alamat'];?></div></td>
                </tr>
                <tr>
    ...
    <div style="text-align:justify;padding:10px 0px;width:610px;">
      Bahwa <?php echo $status_anggota; ?> telah mengajukan Surat Permohonan Pembiayaan tanggal <?php echo date("d-m-Y",strtotime($cetak['tanggal_pengajuan']));?> untuk pembelian/pengadaan barang berupa: "<?php echo $cetak['description'];?>"
    </div>
    <div style="text-align:justify;padding:10px 0px;width:610px;">
      Bahwa KOPERASI telah menyatakan persetujuannya untuk memberikan Pembiayaan Murabahah kepada <?php echo $status_anggota; ?> melalui Surat Pemberitahuan Persetujuan Pembiayaan (SP3) nomor <?php echo $cetak['account_financing_no'];?>/SP3/<?php echo date("Y/m/d",strtotime($cetak['tanggal_akad']));?> yang merupakan bagian dan satu kesatuan dengan akad ini.
    </div>
    <div style="text-align:justify;padding:10px 0px;width:610px;">
      Bahwa selanjutnya KOPERASI dan <?php echo $status_anggota; ?> dengan ini telah setuju dan sepakat untuk mengadakan Akad Pembiayaan Murabahah (selanjutnya disebut "Akad") berdasarkan ketentuan-ketentuan sebagai berikut:
    </div>
  </div>
  ...
  <table cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="305">
        <div style="padding-top:6px;">
          <?php echo $cetak['jenis_jaminan'];?> <?php if (isset($cetak['jenis_jaminan_sekunder'])) echo ', dan '.$cetak['jenis_jaminan_sekunder'];?>
        </div>
      </td>
    </tr>
    <tr>
      ...
      <td width="305">
        <div style="padding-top:6px;">
          <?php echo $cetak['keterangan_jaminan'];?> <?php if (isset($cetak['jenis_jaminan_sekunder'])) echo ', dan '.$cetak['keterangan_jaminan_sekunder'];?>
        </div>
      </td>
    </tr>
    <tr>
  ...
  <!-- PASAL 2 -->
  <div style="margin-left:50px;font-weight:bold;font-size:14px;line-height:25px;text-align:center;margin-top:15px;width:610px;">
    PASAL 2<br>
    PELAKSANAAN PRINSIP MURABAHAH<br>
  </div>
  
  <div style="text-align:justify;line-height:20px;;margin-top:10px;width:610px;">
    Pelaksanaan prinsip Murabahah yang berlangsung antara KOPERASI sebagai Penjual dengan <?php echo $status_anggota; ?> sebagai Pembeli dilaksanakan berdasarkan ketentuan Syariah dan diatur menurut ketentuan-ketentuan dan persyaratan sebagai berikut:
  </div>
  <table cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          <?php echo $status_anggota; ?> membutuhkan barang dan meminta kepada KOPERASI untuk membeli barang tersebut serta menyediakan Pembiayaan Murabahah guna pembelian barang.
        </div>
      </td>
    </tr>
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          KOPERASI bersedia membeli dan kemudian menjual barang tersebut kepada <?php echo $status_anggota; ?> serta memberikan Pembiayaan Murabahah sesuai dengan permohonan <?php echo $status_anggota; ?>.
        </div>
      </td>
    </tr>
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          Apabila KOPERASI telah memiliki barang yang diminta dan dibutuhkan <?php echo $status_anggota; ?>, maka KOPERASI dapat langsung memberikan Pembiayaan Murabahah guna pembelian barang.
        </div>
      </td>
    </tr>
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          <?php echo $status_anggota; ?> bersedia membayar Harga Jual barang sesuai Akad ini, dan Harga Jual tersebut tidak berubah selama berlakunya Akad ini.
        </div>
      </td>
    </tr>
    <tr>
      <td width="20" valign="top"><div style="padding-top:6px">5.</div></td>
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          KOPERASI dapat mewakilkan secara penuh dan/atau memberi kuasa kepada <?php echo $status_anggota; ?> untuk membeli dan menerima barang dari Pemasok dengan Akad Wakalah yang merupakan satu kesatuan yang tidak dapat dipisahkan dari Akad ini.
        </div>
      </td>
    </tr>
  </table>
  ...
  <div style="text-align:justify;line-height:20px;;margin-top:10px;width:610px;">
    KOPERASI akan merealisasikan Pembiayaan berdasarkan prinsip Murabahah berdasarkan Akad ini, setelah <?php echo $status_anggota; ?> terlebih dahulu memenuhi seluruh persyaratan sebagai berikut:
  </div>
  <div style="margin-left:30px;">
    <table cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="500">
          <div style="padding-top:6px;text-align:justify;line-height:20px;">
            Menyerahkan kepada KOPERASI seluruh dokumen yang disyaratkan oleh KOPERASI termasuk tetapi tidak terbatas pada dokumen bukti diri <?php echo $status_anggota; ?>, Bukti Kepemilikan Jaminan dan/atau surat lainnya yang berkaitan dengan Akad ini dan pengikatan Jaminan, yang ditentukan dalam Surat Pemberitahuan Persetujuan Pembiayaan (SP3) dari KOPERASI.
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td width="500">
          <div style="padding-top:6px;text-align:justify;line-height:20px;">
            <?php echo $status_anggota; ?> wajib membuka dan memelihara rekening tabungan pada KOPERASI selama <?php echo $status_anggota; ?> mendapatkan Pembiayaan Murabahah dari KOPERASI.
          </div>
        </td>
      </tr>
      <tr>
...
<br>
  ...
  <div style="margin-left:20px;width:610px;">
    <!-- PASAL 4 -->
    <div style="font-weight:bold;font-size:14px;line-height:25px;text-align:center;margin-top:15px;">
      PASAL 4<br>
      JATUH TEMPO PEMBIAYAAN<br>
    </div>
    <div style="text-align:justify;line-height:20px;;margin-top:10px;">Berakhirnya jatuh tempo Pembiayaan tidak dengan sendirinya menyebabkan Utang Murabahah lunas sepanjang masih terdapat sisa Utang Murabahah <?php echo $status_anggota; ?>.</div>
  </div>
<br>
  <div style="width:610px;margin-left:20px;">
    <!-- PASAL 5 -->
    <div style="font-weight:bold;font-size:14px;line-height:25px;text-align:center;margin-top:15px;">
      PASAL 5<br>
      POTONGAN HARGA/DISKON<br>
    </div>
    <div style="text-align:justify;line-height:20px;;margin-top:10px;">Jika KOPERASI mendapat potongan harga dari pemasok, maka potongan itu merupakan hak <?php echo $status_anggota; ?>, baik terjadi sebelum maupun sesudah Akad.</div>
  </div>
<br>
  <div style="width:610px;margin-left:20px;">
    <!-- PASAL 6 -->
    ...
    <div style="text-align:justify;line-height:20px;;margin-top:10px;"><?php echo $status_anggota; ?> wajib melakukan pembayaran kembali Pembiayaan Murabahah secara Angsuran sampai dengan seluruh Utang Murabahah <?php echo $status_anggota; ?> lunas sesuai dengan jadwal Angsuran yang disepakati.</div>
  </div>
<br>
  <div style="width:610px;margin-left:20px;">
    <!-- PASAL 7 -->
    ...
    <div style="text-align:justify;line-height:20px;;margin-top:10px;">Utang Murabahah <?php echo $status_anggota; ?> yang tidak dilunasi selambat-lambatnya pada saat jatuh tempo akan dikenakan Ganti Rugi (Ta'widh) yang besarnya sebagaimana diatur dalam Pasal 1 huruf n.</div>
  </div>
<br>
  <div style="width:610px;margin-left:20px;">
  <!-- PASAL 8 -->
    ...
    <div style="text-align:justify;line-height:20px;;margin-top:10px;">
      KOPERASI dapat meminta kepada <?php echo $status_anggota; ?> Uang Muka (urbun) untuk pembelian barang pada saat Akad ini dengan ketentuan Uang Muka tersebut menjadi bagian pelunasan Utang Murabahah <?php echo $status_anggota; ?> apabila Pembiayaan Murabahah dilaksanakan.
    </div>
  </div>
  <br>
  ...
  <div style="text-align:justify;line-height:20px;;margin-top:10px;">
    Menyimpang dari pembayaran Angsuran, <?php echo $status_anggota; ?> dapat melakukan Pelunasan Dipercepat yang dilakukan sebelum berakhirnya jatuh tempo Pembiayaan.
  </div>
  </div>
  <br>
  ...
  <div style="text-align:justify;line-height:20px;;margin-top:10px;">
    Guna menjamin pembayaran kembali Utang Murabahah, <?php echo $status_anggota; ?> wajib menyerahkan barang yang dibiayai sebagai Jaminan, serta menyerahkan Bukti Kepemilikan Jaminan yang asli dan sah untuk diikat sesuai dengan ketentuan peraturan perundang-undangan yang berlaku, berupa jenis jaminan : "<?php echo $cetak['jenis_jaminan'];?> <?php if (isset($cetak['jenis_jaminan_sekunder'])) echo ', dan '.$cetak['jenis_jaminan_sekunder'];?>" serta bukti kepemilikan jaminan : "<?php echo $cetak['keterangan_jaminan'];?> <?php if (isset($cetak['jenis_jaminan_sekunder'])) echo ', dan '.$cetak['keterangan_jaminan_sekunder'];?>"
  </div>
  </div>
  <div style="width:610px;margin-left:20px;">
  <!-- PASAL 11 -->
  ...
  <div style="text-align:justify;line-height:20px;;margin-top:10px;">
    Selama jangka waktu Pembiayaan, <?php echo $status_anggota; ?> wajib untuk menutup asuransi jiwa dan asuransi atas barang yang dijaminkan pada perusahaan asuransi berdasarkan Syariah yang disetujui oleh KOPERASI.
  </div>
  </div>
  <br>
  <br>
  ...
  <div style="font-weight:bold;font-size:14px;line-height:25px;text-align:center;margin-top:15px;">
    PASAL 12<br>
    <?php echo $status_anggota; ?> CIDERA JANJI<br>
  </div>
  <div style="text-align:justify;line-height:20px;;margin-top:10px;">
  ...
  <div style="text-align:justify;line-height:20px;;margin-top:10px;">
    Menyimpang dari jangka waktu Pembiayaan, KOPERASI berhak mengakhiri jangka waktu Pembiayaan dan menagih pelunasan sekaligus atas seluruh sisa Utang Murabahah dan <?php echo $status_anggota; ?> wajib membayar dengan seketika dan melunasi sekaligus atas sisa Utang Murabahah atau KOPERASI berhak melakukan upaya-upaya hukum lain untuk menyelesaikan Pembiayaan sesuai Akad ini, apabila <?php echo $status_anggota; ?> cidera janji.
  </div>
  </div>
  <br>

  <!-- PASAL 14 -->
  <div style="margin-left:20px;font-weight:bold;font-size:14px;line-height:25px;text-align:center;margin-top:15px;width:610px;">
    PASAL 14<br>
  ...
  <table cellspacing="0" cellpadding="0" style="margin-left:30px">
    ...
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          Hasil eksekusi dan/atau penjualan barang Jaminan tersebut diprioritaskan untuk melunasi seluruh sisa Utang Murabahah <?php echo $status_anggota; ?> kepada KOPERASI, termasuk semua biaya yang telah dikeluarkan KOPERASI guna melaksanakan eksekusi barang Jaminan, dan apabila masih ada sisanya maka jumlah sisa tersebut akan dibayarkan kepada <?php echo $status_anggota; ?>.
        </div>
      </td>
    </tr>
    <tr>
      ...
      <td width="580">
        <div style="padding-top:6px;text-align:justify;line-height:20px;">
          Apabila dari hasil penjualan atau eksekusi barang Jaminan Pembiayaan jumlahnya belum mencukupi untuk melunasi seluruh Utang Murabahah <?php echo $status_anggota; ?> kepada KOPERASI, maka sesuai dengan ketentuan atau peraturan yang berlaku, KOPERASI berhak untuk mengambil pelunasan atas sisa Utang Murabahah tersebut dari penjualan barang-barang lain milik <?php echo $status_anggota; ?>.
        </div>
      </td>
    </tr>
  </table>
...
<br>
  ...
  <br>
  <br>
  <div style="margin-left:20px;text-align:justify;line-height:20px;;margin-top:30px;width:610px;">
  ...
  <div style="width:610px;margin-left:20px;margin-top:30px;;">
