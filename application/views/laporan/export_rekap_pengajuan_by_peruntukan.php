...
<page>
      <div style="width:100%;">
        ...
        <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:16px;">
        Rekap Pengajuan Pembiayaan Berdasarkan Peruntukan
        </div>
...
<table id="hor-minimalist-b" align="center">
    <tbody>
      <tr>
            <td class="no" style="width:100px;">Kode</td>
            <td class="anggota" style="width:120px;">Keterangan</td>
      ...
      <tr class="value">
            ...
            <td class="val_anggota" style="padding:5px;"><?php echo $data['display_text'];?></td>
