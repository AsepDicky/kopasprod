...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Pencairan Deposito</div>
      <div class="tools">
...
/* BEGIN DIALOG ACTION BRANCH */
   ...
   /* END DIALOG ACTION REMBUG */
      ...
      $("#previewxls").click(function(e)
      {
        ...
        window.open('<?php echo site_url();?>laporan_to_excel/export_lap_droping_deposito/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code);
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var tanggal = datepicker_replace($("#tanggal").val());
        var tanggal2 = datepicker_replace($("#tanggal2").val());
        window.open('<?php echo site_url();?>laporan_to_pdf/export_lap_droping_deposito/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code);
      });
