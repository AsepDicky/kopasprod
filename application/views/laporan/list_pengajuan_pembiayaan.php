...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>List Pengajuan Pembiayaan</div>
      <div class="tools">
              ...
              <form>
                ...
                <table id="filter-form">
                   ...
                   <tr style="display:none;">
                    <td style="padding-bottom:10px;" width="150">Tipe CIF</td>
                    <td>
                      <select name="cif_type" id="cif_type" style="width:190px;">
                   ...
                   <tr id="field_rembug" style="display:none;">
                   ...
                   <tr style="display:none;">
                      <td width="150" valign="top">Petugas</td>
                      <td valign="top">
                   ...
                   <tr style="display:none;">
                      <td width="150" valign="top">Resort</td>
                      <td valign="top">
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if(cif_type==0){
          if(branch_code==""){
            ...
            window.open('<?php echo site_url();?>laporan_to_excel/export_list_pengajuan_pembiayaan_kelompok/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code+'/'+cif_type+'/'+petugas+'/'+produk+'/'+status);
          }
        }else{
          if(branch_code==""){
            alert('Kantor Cabang Masih Kosong');
            ...
            window.open('<?php echo site_url();?>laporan_to_excel/export_list_pengajuan_pembiayaan_individu/'+tanggal+'/'+tanggal2+'/'+cif_type+'/'+branch_code+'/'+petugas+'/'+produk+'/'+resort+'/'+status+'/'+akad+'/'+pengajuan_melalui);
          }
        }
      });
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if(cif_type==0){
          if(branch_code==""){
            ...
            window.open('<?php echo site_url();?>laporan_to_pdf/export_list_pengajuan_pembiayaan_kelompok/'+tanggal+'/'+tanggal2+'/'+branch_code+'/'+cm_code+'/'+cif_type+'/'+petugas+'/'+produk+'/'+status);
          }
        }else{
          if(branch_code==""){
            alert('Kantor Cabang Masih Kosong');
            ...
            window.open('<?php echo site_url();?>laporan_to_pdf/export_list_pengajuan_pembiayaan_individu/'+tanggal+'/'+tanggal2+'/'+cif_type+'/'+branch_code+'/'+petugas+'/'+produk+'/'+resort+'/'+status+'/'+akad+'/'+pengajuan_melalui);
          }
        }
      });
