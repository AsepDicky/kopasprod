...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#">Pengajuan Reinburs</a></li> 
        </ul>
...
<div id="add">
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption"><i class="icon-upload"></i>List Pengajuan</div>
            <div class="tools">
      ...
      <div class="portlet-body form">
        <div class="append-bu" style="float:right;margin-right:10px;">
          ...
          <button id="delete_trx" class="btn red" style="font-size:13px;">Delete Pengajuan</button>
          <button id="save_trx" class="btn green" style="font-size:13px;">Save Pengajuan</button>
        </div>
        <div class="portlet-body form">
          <div class="row-fluid">
             <div class="span12">
