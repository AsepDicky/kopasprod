...
<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="page-title">Pendebetan Angsuran <small>Pendebetan Angsuran Channeling</small></h3>
        <ul class="breadcrumb">
            <li>
                <i class="icon-home"></i>
            ...
            <li><a href="#">Pendebetan Angsuran Channeling</a></li> 
        </ul>
...
<div id="add">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-upload"></i>Pendebetan Angsuran</div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="<?php echo site_url('transaction/do_upload_pendebetan_angsuran_channeling'); ?>" method="post" enctype="multipart/form-data" id="FormAdd" class="form-horizontal">
        ...
        <div class="portlet-body form">
          <div class="append-bu" style="float:right;margin-right:10px;">
            <a href="<?= base_url() ?>index.php/transaction/list_tagihan" target="_blank"><button class="btn blue" style="font-size:13px;">Check Tagihan</button></a>
            <button id="delete_trx" class="btn red" style="font-size:13px;">Delete Pendebetan</button>
            <button id="save_trx" class="btn green" style="font-size:13px;">Save Pendebetan Channeling</button>
        </div>
        <div class="portlet-body form">
          <div class="row-fluid">
             <div class="span12">
...
$(function(){
  ...
  $("#jqGrid_pendebetan_angsuran").jqGrid({
      url: site_url+'transaction/jqgrid_pendebetan_angsuran_channeling',
      mtype: "GET",
      datatype: "json",
      colModel: [
  ...
  $("#delete_trx").click(function(e){
    ...
    if(conf){
      ...
      $.ajax({
        type:"GET",
        dataType: "json",
        url: site_url+'transaction/delete_upload_pendebetan_angsuran',
        error: function(){
          $.unblockUI
  ...
  $("#save_trx").click(function(e){
    ...
    if(trx_date==""){
      ...
      $.ajax({
        ...
        url: site_url+'transaction/process_pendebetan_angsuran_pembiayaan_koptel_channeling',
        error: function(){
          $.unblockUI
          App.WarningAlert("Failed to Conenct into Databases !");
        },
          ...
          if(response.success==true){
            ...
            if (response.is_unins>0) {
              ...
              if (response.is_canceled>0) {
                ...
                window.location.href=site_url+"transaction/export_finance_canceled_angsuran/"+angsuran_id;
              }
            }
