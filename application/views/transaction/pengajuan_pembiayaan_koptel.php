         ...
         <div style="float:right;">
           <select id="src_product" name="src_product" class="m-wrap">
             <option value="" maxrate="">Sorting Berdasarkan Produk</option>
              <?php foreach($product2 as $produk){ ?>
      ...
      <div class="row-fluid">
         <div class="span12">
            <table>
               ...
               <!-- <tr>
                 <td width="150">Margin Berjalan*</td>
                 <td><div id="history_sisa_margin"></div></td>
               </tr> -->
            ...
            <div class="alert alert-success hide">
               ...
               New Account Financing has been Created !
                    ...
                    <div class="control-group" id="div_saldo_kewajiban_ke_koptel">
                     ...
                     <div class="control-group">
                       <label class="control-label">Biaya Administrasi Pelunasan</label>
                       <div class="controls">
                          <div class="input-prepend">
                            <span class="add-on">Rp</span>
                            <input type="text" name="biaya_admin_v2" id="biaya_admin_v2" class="small m-wrap mask-money"/>
                          </div>
                       </div>
                    </div> 
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                           <select id="modal" name="modal" class="m-wrap">
                              <option value="">PILIH</option>
...
<script>
   jQuery(document).ready(function() {    
      ...
      $('#akad_code').on('change', function() {
       ...
       $('#modal_code').on('change', function() {
        if(this.value=='2'){
          $('.group-external').show();
          $('#sumber_dana_external').val(null).trigger('change');
        }else{
          $('.group-external').hide();
          $('#sumber_dana_external').val(null).trigger('change');
        }
          ...
          $.ajax({
            ...
            success: function(response)
            {
              ...
              $.ajax({
                 ...
                 success: function(response3){
                    ...
                    for(k = 0 ; k < response3.length ; k++){
                      ...
                      var _jenis_margin = response3[k].jenis_margin;

                      if(_jenis_margin==3)
                      {
                        var _margin = (response3[k].saldo_pokok * (response3[k].rate_margin2)/100) / 12;
                      }
                      else if(_jenis_margin==1)
                      {
                        var _margin = response3[k].angsuran_margin;
                      }
                      else
                      {
                        var _margin = response3[k].angsuran_margin;
                      ...
                      var _saldo_pokokv2 = parseFloat(response3[k].saldo_pokok);
                      var _marginv2 = parseFloat(_margin);
                      var _outstanding = _saldo_pokokv2+_marginv2;

                      var _counter_angsuranv2 = response3[k].counter_angsuran;

                      if(_counter_angsuranv2<12)
                      {
                        var _biaya_adminv2 = _saldo_pokokv2*1/100;
                        $("#biaya_admin_v2").val(number_format(_biaya_adminv2,0,',','.'));
                      }
                      else
                      {
                        var _biaya_adminv2 = 0;
                        $("#biaya_admin_v2").val(number_format(_biaya_adminv2,0,',','.'));
                      }
                      ...
                      html += ' \
                            <tr>\
                              ...
                              <td align="right" style="height:30px;padding-right:10px;border-right:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">\
                                <input type="hidden" name="check_saldo_pokok[]" value="'+number_format(_outstanding,0,',','.')+'">'+number_format(_outstanding,0,',','.')+'\
                              </td>\
                              <td align="right" style="height:30px;padding-right:10px;border-right:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">\
                              ...
                              <td align="right" style="height:30px;padding-right:10px;border-right:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">\
                                <input type="hidden" name="check_saldo_margin[]" value="'+number_format(_margin,0,',','.')+'">'+number_format(_margin,0,',','.')+'\
                              </td>\
                             <td align="right" style="height:30px;padding-right:10px;border-right:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">\
                              ...
                              <td align="right" style="height:30px;padding-right:10px;border-right:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">\
                                <input type="hidden" name="check_product_name[]" value="'+number_format(response3[k].saldo_pokok,0,',','.')+'">'+number_format(response3[k].saldo_pokok,0,',','.')+'\
                              </td>\
                            </tr>\
                      ';
                    }
              ...
              $.ajax({
                ...
                error:function(){
                  alert("Data Tidak Ditemukan, Coba untuk Crosscek Status Pegawai");
                }
              })
