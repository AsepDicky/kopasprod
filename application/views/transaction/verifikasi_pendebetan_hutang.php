...
<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="page-title">Verifikasi Pendebetan Angsuran <small>Verifikasi Pendebetan Angsuran Hutang</small></h3>
        <ul class="breadcrumb">
            <li>
                <i class="icon-home"></i>
            ...
            <li><a href="#">Verifikasi Pendebetan Angsuran Hutang</a></li> 
        </ul>
...
<div id="add">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-upload"></i>Verifikasi Pendebetan Angsuran Hutang</div>
            <div class="tools">
...
$(function(){
  ...
  $("#jqGrid_angsuran_temp").jqGrid({
      url: site_url+'transaction/jqgrid_angsuran_temp_hutang',
      mtype: "GET",
      datatype: "json",
      postData:{
  ...
  $("#jqGrid_pendebetan_angsuran").jqGrid({
      url: site_url+'transaction/jqgrid_verifikasi_pendebetan_angsuran_hutang',
      mtype: "GET",
      datatype: "json",
      postData:{
        filename : function(){return $("#namafile").val()}
  ...
  $("#save_trx").click(function(e){
    ...
    if (bValid==false) {
      ...
      $.ajax({
        ...
        url: site_url+'transaction/verifikasi_pendebetan_angsuran_pembiayaan_koptel_hutang',
        async: false,
        error: function(){
