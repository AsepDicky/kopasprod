      ...
      <form id="form_process" class="form-horizontal">
        ...
        <table>
          ...
          <tr>
            ...
            <td valign="top">
              <input type="text" name="kas_petugas" tabindex="4" readonly value="<?php echo $this->session->userdata('account_cash_code') ?>"style="padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;"> 
          ...
          <tr>
            ...
            <td valign="top">
              ...
              <input type="text" name="saldo" tabindex="4" readonly value="<?php echo $this->session->userdata('account_cash_code') ?>"style="padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;"> 
      ...
      <form id="process_transaksi_jurnal" method="post">
        ...
        <!-- <div style="padding:10px;border-left:solid 1px #CCC; border-right:solid 1px #CCC; border-top:solid 1px #CCC"> -->
          <table width="100%" id="form">
            <thead>
              <tr>
              	<td align="center" style="padding:5px 0;background:#EEE;border-left:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;" width="496px">PETUGAS</td>
            ...
            <tfoot>
             ...
             <!--   <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
                  ...
                  <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
                  <input type="text" tabindex="7" value="0" id="amount_def" maxlength="20" class="mask-money" style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;">
                </td>
                <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
              ...
              <tr>
              	...
              	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
              		<input type="text" tabindex="10" readonly value="0" id="total_amount_def" name="total_amount_def" class="mask-money" style="width:200px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;">
              	</td>
              	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
              	</td>
              	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;border-right:solid 1px #CCC;">
