...
<div class="row-fluid">
   <div class="span12">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="#">Setoran Kas Besar</a></li> 
    </ul>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Setoran Kas Besar</div>
      <div class="tools">
...
<div id="add" class="hide">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Setoran Kas Besar</div>
         <div class="tools">
            <a href="javascript:;" class="collapse"></a>
         </div>
      </div>
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
            ...
            <div class="alert alert-success hide">
               <button class="close" data-dismiss="alert"></button>
               Transaksi Setoran Kas Besar Sukses. Silahkan Cetak Validasi Transaksi !
            </div>
            </br>
