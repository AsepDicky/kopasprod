...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        Jurnal Penyesuaian <small>Untuk melakukan Penyesuaian Nomor Bukti</small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
          ...
          <table width="100%" id="form">
            ...
            <tfoot>
              <tr>
              	...
              	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
              		<input type="text" tabindex="7" value="0" id="debet_def" class="mask-money" style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;">
              	</td>
              	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
              		<input type="text" value="0" tabindex="8" id="credit_def" class="mask-money" style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;">
              	</td>
              	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
              		<textarea id="description_def" tabindex="9" rows="1" style="width:auto;resize:none;height:20px;padding:4px;margin:5px;box-shadow:0 0 0;"></textarea>
              	</td>
...
$(function(){
  ...
  jQuery("#JurnalUmumRev").jqGrid({
    url: site_url+'transaction/get_jurnal_penyesuaian',
    datatype: 'json',
    height: '300',
    postData: {
    ...
    rowList: [10,20,50,100],
      colNames:['ID','Trx Date','Voucher Date','Nomor Bukti','Description','Total Debit','Total Credit','User Input'],
      colModel:[
          ...
          for(i in response)
          {
            ...
            html += ' \
              <tr> \
                ...
                <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
                  <input type="text" id="debet" name="debet[]" class="mask-money" readonly style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;" value="'+((response[i].flag_debit_credit=='D')?response[i].amount:'0')+'"> \
                </td> \
                <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
                  <input type="text" id="credit" name="credit[]" class="mask-money" readonly style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;" value="'+((response[i].flag_debit_credit=='C')?response[i].amount:'0')+'"> \
                </td> \
                <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
                  <textarea id="description" name="description[]" rows="1" readonly style="width:auto;resize:none;height:20px;padding:4px;margin:5px;box-shadow:0 0 0;">'+response[i].description+'</textarea> \
                </td> \
                <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;border-right:solid 1px #CCC;"> \
    ...
    else
    {
    	html = ' \
    	      <tr> \
            	...
            	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
            		<input type="text" id="debet" name="debet[]" class="mask-money" style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;" value="0"> \
            	</td> \
            	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
            		<input type="text" id="credit" name="credit[]" class="mask-money" style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;" value="0"> \
            	</td> \
            	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
            		<textarea id="description" name="description[]" rows="1" style="width:auto;resize:none;height:20px;padding:4px;margin:5px;box-shadow:0 0 0;"></textarea> \
            	</td> \
            	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;border-right:solid 1px #CCC;"> \
  	...
  	else
  	{
    	...
    	html = ' \
    	      <tr> \
            	...
            	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
            		<input type="text" id="debet" name="debet[]" class="mask-money" readonly style="width:100px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;" value="'+number_format(convert_numeric(debet_def.val()),0,',','.')+'"> \
            	</td> \
            	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
            		<input type="text" id="credit" name="credit[]" class="mask-money" readonly style="width:100px;padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;" value="'+number_format(convert_numeric(credit_def.val()),0,',','.')+'"> \
            	</td> \
            	<td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
