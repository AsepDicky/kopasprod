         ...
         <form>
            <table id="filter-form">
              ...
              <tr>
               ...
               <tr>
                <td valign="middle" width="100">Channeling</td>
                <td>
                  <div class="controls">
                    <select class="chosen" name="channeling" id="channeling" style="width:190px;">
                      <option value="" maxrate="">Semua</option>
                          <option value="1" maxrate="">channeling</option>
                          <option value="2" maxrate="">executing</option>
...
<script type="text/javascript">
  ...
  $("#downloadxls").click(function(e)
  {
    ...
    window.open('<?php echo site_url();?>laporan_to_excel/export_list_tagihan/'+from_date+'/'+thru_date+'/'+akad+'/'+produk_pembiayaan+'/'+status_telkom+'/'+channeling+'/'+code_divisi);
  });

  function view_grid_tagihan()
  {
    jQuery("#list_tagihan").jqGrid({
      url: site_url+"transaction/jqgrid_list_tagihan",
      datatype: 'json',
      height: 'auto',
      autowidth: true,
      postData: {
        ...
        ,channeling : function(){return $("#channeling").val()}
      ...
      rowList: [50,100,150,200,250,300,350,400],
        colModel: [
          ...
          { label: 'Channeling', name: 'channeling', width: 100 },
