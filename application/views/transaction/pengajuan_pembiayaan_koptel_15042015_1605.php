            ...
            <div class="alert alert-success hide">
               ...
               New Account Financing has been Created !
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                          <input type="text" name="nik" id="nik" data-required="1" class="medium m-wrap"  maxlength="10" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <div class="input-prepend">
                             ...
                             <input type="text" class="large m-wrap" name="atasnama_rekening" id="atasnama_rekening" maxlength="50" onkeyup="this.value=this.value.toUpperCase()">
                           </div>
                        </div>
                    </div>    
                    <hr>    
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                          <div class="input-prepend">
                            ...
                            <input type="text" name="thp" id="thp" class="medium m-wrap mask-money"/>
                          </div>
                       </div>
                    </div> 
                    <div class="control-group">
                       ...
                       <div class="controls">
                          <div class="input-prepend">
                            <span class="add-on">Rp</span>
                          <input type="text" name="thp_40" id="thp_40" class="medium m-wrap mask-money"  readonly="" style="background-color:#eee;"/>
                          <!-- <input type="text" name="thp_40" id="thp_40" class="medium m-wrap mask-money" readonly="" style="background-color:#eee;"/> -->
                          </div>
                       </div>
                    </div>            
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                          <div class="input-prepend input-append">
                            <span class="add-on">Rp</span>
                            <input type="text" class="m-wrap mask-money" style="width:120px;" name="jumlah_angsuran" id="jumlah_angsuran" maxlength="10" value="0">
                            <span class="add-on">,00</span>
                          </div>
                          &nbsp;&nbsp;<input type="checkbox" id="lunasi_ke_kopegtel" name="lunasi_ke_kopegtel" value="1"/><span id="span_txt_lunasi"> Lunasi</span>
                       </div>
                    </div> 
                    <div class="control-group" id="div_saldo_kewajiban" style="display:none;">
                        <label class="control-label">Saldo Kewajiban Ke Kopegtel<span class="required">*</span></label>
                        <div class="controls">
                          <div class="input-prepend input-append">
                            <span class="add-on">Rp</span>
                            <input type="text" class="m-wrap mask-money" style="width:120px;" name="saldo_kewajiban" id="saldo_kewajiban" maxlength="10" value="0">
                            <span class="add-on">,00</span>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                           <div class="input-prepend input-append">
                             <span class="add-on">Rp</span>
                             <input type="text" class="m-wrap mask-money" style="width:120px;" name="amount" id="amount" maxlength="10" value="0">
                             <span class="add-on">,00</span>
                           </div>
                         </div>
                    </div> 
...
// })
    ...
    $("#product_code","#form_add").change(function(){
      cek_max_jangka_waktu_add($(this).val());
    })
                  ...
                  success: function(response){
                    if(response.success==true){
                      $.alert({
                        ...
                        content:'Pengajuan Berhasil diinput',
