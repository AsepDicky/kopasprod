...
<div class="row-fluid">
   <div class="span12">
      ...
      <h3 class="form-section">
        Transaksi Kas Kecil <small></small>
      </h3>
      <!-- END PAGE TITLE-->
   </div>
</div>
   ...
   <!-- DIALOG FA -->
        ...
        <table>
          <tr>
            ...
            <td width="100" valign="top">Saldo</td>
            <td valign="top">
            
              <input type="text" name="saldo" class="mask-money" tabindex="4" readonly value="<?php echo $petugas['saldo'] ?>"style="padding:4px;margin-top:5px;margin-bottom:2px;box-shadow:0 0 0;"> 
            ...
            <td valign="top">
              <input type="text" name="kas_petugas" tabindex="4" readonly value="<?php echo $petugas['account_cash_name'] ?>"style="padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;"> 
          ...
          <tr>
            ...
            <td valign="top" width="260">
              <textarea id="deskripsi" name="deskripsi_form" tabindex="4" style="padding:4px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0; display: none;"></textarea>
            </td>
      ...
      <!-- <hr> -->
      <p>&nbsp;</p>
      <form id="process_transaksi_jurnalsek" method="post">

        <input type="hidden" name="branch_code" value="<?php echo $this->session->userdata('branch_code'); ?>">
        <input type="hidden" name="account_cash_code" value="<?php echo $this->session->userdata('account_cash_code'); ?>">
        ...
        <!-- <div style="padding:10px;border-left:solid 1px #CCC; border-right:solid 1px #CCC; border-top:solid 1px #CCC"> -->
          <table width="100%" id="form">
            <thead>
              ...
              <td align="center" style="padding:5px 0;background:#EEE;border-left:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;"></td>
            ...
            <tfoot>
              <tr>
                <td align="left" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;padding-left:10px;">
                ...
                <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
                  <input type="hidden" tabindex="7" value="0" id="debet_def" maxlength="20"  style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;">
                </td>
                <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">
...
$(function(){
 ...
 $("#total_amount_def").bind('calculate',function(){
    ...
    $("input#credit").each(function(){
      total += parseFloat(convert_numeric($(this).val()));
  ...
  $(".search").click(function(e){
    ...
    if(form1.valid()===true)
    {
      ...
      $.ajax({
        url: site_url+"transaction/ajax_get_gl_account_sek",
        type: "POST",
        dataType: "json",
...
$("#keyword","#dialog_kas_petugas").keypress(function(e){
    ...
    if(e.which==13){
      $.ajax({
         ...
         success: function(response){
            ...
            for ( i = 0 ; i < response.length ; i++ )
         {
            html += '<option value="'+response[i].account_cash_code+'" account_cash_id="'+response[i].account_cash_id+'" fa_code="'+response[i].fa_code+'" saldo="'+response[i].saldo+'" account_cash_name="'+response[i].account_cash_name+'">('+response[i].account_cash_code+') '+response[i].account_cash_name+'</option>';
          }
  ...
  $("#select","#dialog_kas_petugas").click(function(){
    ...
    saldo = $("#result option:selected","#dialog_kas_petugas").attr('saldo');
  ...
  $(".search").click(function(e){
    ...
    if(form1.valid()===true)
    {
      ...
      $("input[name='fa_code']").val($("input[name='fa_code']").val());
    ...
    else
    {
      html = ' \
            <tr> \
              ...
              <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
                <input type="hidden" id="debet" name="debet[]" maxlength="20" class="mask-money" style="width:auto;padding:4px;margin:5px;box-shadow:0 0 0;" value="0"> \
              </td> \
              <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
    ...
    else
    {
      ...
      html = ' \
            <tr> \
              ...
              <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
                <input type="hidden" id="debet" name="debet[]" readonly style="text-align:right;width:auto;padding:4px;margin:5px;box-shadow:0 0 0;" value="'+number_format(convert_numeric(debet_def.val()),0,',','.')+'"> \
              </td> \
              <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
      ...
      $("#process_transaksi_jurnalsek tbody").append(html);
      $("select#account:last").val(account_def.val());
  ...
  $("#save_trx").click(function(){
    ...
    else
    {
      ...
      $.ajax({
        type: "POST",
        dataType: "json",
        data: $("#process_transaksi_jurnalsek").serialize(),
        url: site_url+"transaction/process_transaksi_jurnalsek",
        async: false,
        success: function(response){
          if(response.success===true){
            alert(response.message);
            $("#process_transaksi_jurnalsek tbody").html('<tr></tr>');
            $("#deskripsi").val('');
