...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Pembiayaan <small>Cek Outstanding</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
...
<div class="portlet box red" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Cek Outstanding</div>
      <div class="tools">
                      ...
                      html += ' \
                            <tr>\
                             ...
                             <td align="right" style="height:30px;padding-right:10px;border-right:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">\
                              ...
                              <td align="right" style="height:30px;padding-right:10px;border-right:solid 1px #CCC;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;">\
                                <input type="hidden" name="check_product_name[]" value="'+number_format(_outstanding,0,',','.')+'">'+number_format(_outstanding,0,',','.')+'\
                              </td>\
                            </tr>\
                      ';
                    }
