...
$(function(){
          ...
          <tr> \
            <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
              ...
              <input type="hidden" name="account_cash_id[]" id="account_cash_id" value="0"> \
               <input type="hidden" name="account_cash_code[]" id="account_cash_code" value="0"> \
  ...
  $("a#save").live('click',function(){
    ...
    else
    {
      ...
      var account_cash_code = account_def_option.attr('account_cash_code');
      ...
      $(this).parent().parent().find("#account_cash_name").val(account_cash_name);
       $(this).parent().parent().find("#account_cash_code").val(account_cash_name);
    ...
    html = ' \
          <tr> \
            <td align="center" style="border-bottom:solid 1px #CCC;border-left:solid 1px #CCC;"> \
              ...
              <input type="hidden" name="account_cash_name[]" id="account_cash_code" value="'+account_cash_code+'"> \
