            ...
            <div class="alert alert-success hide">
               ...
               Setup Kas Petugas Berhasil Diproses !
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                         <select name="cabang" id="cabang" class="chosen large m-wrap" data-required="1">                     
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                         <select name="petugas" id="petugas" class="chosen large m-wrap" data-required="1">                     
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                         <select name="account_name" id="account_name" class="large m-wrap chosen" data-required="1">                     
                            <option value="">PILIH</option>
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                          <input type="text" name="nama_kas" id="nama_kas" readonly="" data-required="1" class="large m-wrap"/>
                        </div>
                    </div>             
                    <div class="control-group">
               ...
               <form action="#" id="form_edit" class="form-horizontal">
                  ...
                  <br>  
                    <div class="control-group">
                       <label class="control-label">Cabang<span class="required">*</span></label>
                       <div class="controls">
                         <select name="cabang2" id="cabang2" class="chosen large m-wrap" data-required="1">                     
                            <option value="">PILIH</option>
                            <?php foreach($branch as $data): ?>
                    ...
                    <div class="control-group">
                       <label class="control-label">Petugas<span class="required">*</span></label>
                       <div class="controls">
                         <select name="petugas2" id="petugas2" class="chosen large m-wrap" data-required="1">                     
                    ...
                    <div class="control-group">
                       <label class="control-label">GL Account<span class="required">*</span></label>
                       <div class="controls">
                         <select name="account_name2" id="account_name2" class="large m-wrap chosen" data-required="1">                     
                            <option value="">PILIH</option>
                            <?php foreach($account_name as $data): ?>
                              <option value="<?php echo $data['account_code'];?>"><?php echo $data['account_code'];?> - <?php echo $data['account_name'];?></option>
                            <?php endforeach?>
                    ...
                    <div class="control-group">
                       <label class="control-label">Nama Kas<span class="required">*</span></label>
                       <div class="controls">
                          <input type="text" name="nama_kas2" id="nama_kas2" readonly="" data-required="1" class="large m-wrap"/>
                        </div>
                    </div>             
                    <div class="control-group">
                       <label class="control-label">Jenis Kas<span class="required">*</span></label>
...
$(function(){
      ...
      $("select[name='cabang2']").change(function(){ //UNTUK FORM EDIT
         ...
         $.ajax({
           ...
           success: function(response){
              ...
              $("#petugas2").html(html);
              $('#petugas2').trigger("liszt:updated");
           }
        });        
      }); 
      //END baru 03-09-2013
     ...
     $("select[name='account_name2']").change(function(){
      ...
      $("#btn_add").click(function(){
        ...
        form1.trigger('reset');
        /* reset chosen value */
        $("#cabang","#form_add").trigger('liszt:updated');
        $("#petugas","#form_add").html('');
        $("#petugas","#form_add").trigger('liszt:updated');
        $("#account_name","#form_add").trigger('liszt:updated');
      });
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            $("#form_edit select[name='cabang2']").val(response.branch_code).trigger('change');
            ...
            $("#form_edit select[name='cabang2']").trigger('liszt:updated');
            $("#form_edit select[name='petugas2']").trigger('liszt:updated');
            $("#form_edit select[name='account_name2']").trigger('liszt:updated');
          }
        })
