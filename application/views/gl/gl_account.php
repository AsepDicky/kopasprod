   ...
   <div class="portlet-body">
      ...
      <div class="clearfix" style="background:#EEE" id="form-filter">
        ...
        <div style="padding:5px;float:left;">
          <select id="account_type" name="account_type" class="small m-wrap" data-required="1" style="margin:0 5px;">
        ...
        <div style="padding:5px;float:left;">
          <select id="account_group" name="account_group" class="large m-wrap" data-required="1" style="margin:0 5px;">
              <option value="">PILIH</option>
          </select>
        </div>
        <div style="padding:5px;float:left;">
            ...
            <div class="alert alert-success hide">
               ...
               Setup GL Account Berhasil Diproses !
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                          <input type="text" name="account_code" id="account_code" data-required="1" class="medium m-wrap" maxlength="7" />
                       </div>
                    </div>            
                    <div class="control-group">
               ...
               <form action="#" id="form_edit" class="form-horizontal">
                  ...
                  <br>  
                    ...
                    <div class="control-group">
                       <label class="control-label">Account Code<span class="required">*</span></label>
                       <div class="controls">
                          <input type="text" name="account_code2" id="account_code" data-required="1" class="medium m-wrap" maxlength="7" />
                       </div>
                    </div>            
                    <div class="control-group">
                       <label class="control-label">Account Name<span class="required">*</span></label>
...
$.alert({
     ...
     content:'GL Account has been ADDED',
     ...
     confirm:function(){
      ...
      $("#save").click(function(){
              ...
              if(code_account=="")
              {
                  Template.WarningAlert('Account Code Belum Diisi');    
              }
              else
              {
...
$.alert({
     ...
     confirm:function(){
        $(".close","#dialog_budget").trigger('click');
                  ...
                  // Template.WarningAlert('Budget Berhasil Disimpan');
                }
                else if(response.success==false)
                {
                  Template.WarningAlert('Budget Gagal Disimpan');
                }
              }
...
$.confirm({
     title:'Deleting',icon:'icon-trash',backgroundDismiss:false,
     content:'Deleting GL Account. Are You Sure?',
...
$.alert({
    title:"Success",icon:'icon-check',backgroundDismiss:false,
    content:'GL Account has been DELETED',
    confirmButtonClass:'btn green',
    confirm:function(){
      dTreload();
    }
                  ...
                  // Template.WarningAlert("Delete Failed!");
