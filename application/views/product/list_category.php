...
$(function(){
      ...
      form1.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/add_list_category",
              dataType: "json",
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          url: site_url+"product/get_list_category_by_list_code_id",
          success: function(response)
          {
      ...
      form2.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/edit_list_category",
              dataType: "json",
      ...
      $("#btn_delete").click(function(){
        ...
        if(list_code_id.length==0){
          ...
          if(conf){
            $.ajax({
              type: "POST",
              url: site_url+"product/delete_list_category",
              dataType: "json",
              data: {list_code_id:list_code_id},
              success: function(response){
                if(response.success==true){
      ...
      $('#produk_tabungan').dataTable({
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": site_url+"product/datatable_list_category",
          "aoColumns": [
...
<?php $this->load->view('product/detail_list_category')?>