...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Product Setup <small>Produk Hutang</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Produk Hutang</div>
      <div class="tools">
      ...
      */
      ...
      form1.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/add_produk_financing_hutang",
              dataType: "json",
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          url: site_url+"product/get_financing_by_product_id_hutang",
          success: function(response)
          {
      ...
      form2.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/edit_produk_financing_hutang",
              dataType: "json",
      ...
      $("#btn_delete").click(function(){
        ...
        if(product_financing_id.length==0){
          ...
          if(conf){
            $.ajax({
              type: "POST",
              url: site_url+"product/delete_produk_pembiayaan_hutang",
              dataType: "json",
              data: {product_financing_id:product_financing_id},
              success: function(response){
                if(response.success==true){
      ...
      $('#produk_pembiayaan').dataTable({
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": site_url+"product/datatable_produk_pembiayaan_hutang",
          "aoColumns": [
