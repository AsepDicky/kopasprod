...
<div class="portlet box red" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>GL HUTANG</div>
      <div class="tools">
...
<div id="add" class="hide">
   ...
   <div class="portlet box red">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Tambah GL HUTANG</div>
         <div class="tools">
            <a href="javascript:;" class="collapse"></a>
         </div>
      </div>
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="jenis_gl" id="jenis_gl" class="medium m-wrap" data-required="1">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" name="product_financing_gl_code" id="product_financing_gl_code" data-required="1" class="small m-wrap"  onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="5" />
            ...
            <div class="control-group">
               <label class="control-label">GL Titipan Pencairan</label>
               <div class="controls">
                  <select name="gl_titipan_pencairan" id="gl_titipan_pencairan" class="chosen large m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <?php
                     foreach ($gl_account as $data): 
                     ?>
   ...
   <div class="portlet box red">
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_edit" class="form-horizontal">
          <input type="hidden" id="product_financing_gl_id" name="product_financing_gl_id">
            <div class="alert alert-error hide">
               <button class="close" data-dismiss="alert"></button>
               You have some form errors. Please check below.
            </div>
            ...
            <div class="control-group">
               <label class="control-label">GL Titipan Pencairan</label>
               <div class="controls">
                  <select name="gl_titipan_pencairan" id="gl_titipan_pencairan2" class="chosen large m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <?php
                     foreach ($gl_account as $data): 
                     ?>
...
$(function(){
      ...
      $("#btn_add").click(function(){
        ...
        form1.trigger('reset');
        $("#rencana").hide();
        $(".chosen",form1).trigger('liszt:updated');
      });
      ...
      $("#jenis_gl","#form_add").change(function()
      {
        var jenis_gl = $("#jenis_gl","#form_add").val();
          if (jenis_gl=='2') 
          {
            $("#gl_saldo_tab_wajib","#form_add").parent().parent().hide();
            $("#gl_saldo_tab_kelompok","#form_add").parent().parent().hide();
            ...
            $("#gl_saldo_tab_wajib","#form_add").attr("disabled", true);
            $("#gl_saldo_tab_kelompok","#form_add").attr("disabled", true);
            $("#gl_saldo_tab_sukarela","#form_add").attr("disabled", true);
            $("#gl_saldo_tab_wajib","#form_add").css("backgroundColor", "#EFEFEF");
            $("#gl_saldo_tab_kelompok","#form_add").css("backgroundColor", "#EFEFEF");
            $("#gl_saldo_tab_sukarela","#form_add").css("backgroundColor", "#EFEFEF");*/
          }
          else
          {
            ...
            $("#gl_saldo_tab_wajib","#form_add").attr("disabled", false);
            $("#gl_saldo_tab_kelompok","#form_add").attr("disabled", false);
            $("#gl_saldo_tab_sukarela","#form_add").attr("disabled", false);
            $("#gl_saldo_tab_wajib","#form_add").css("backgroundColor", "#FFFFFF");
            $("#gl_saldo_tab_kelompok","#form_add").css("backgroundColor", "#FFFFFF");
            $("#gl_saldo_tab_sukarela","#form_add").css("backgroundColor", "#FFFFFF");*/
          }
      });
      ...
      form1.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/add_produk_gl_pembiayaan_hutang",
              dataType: "json",
      ...
      $("a#link-detail").live('click',function(){
        ...
        $.ajax({
          ...
          url: site_url+"product/get_financing_gl_by_product_id_view_hutang",
          success: function(response)
          {
            ...
            var html = ' \
                        ...
                        <tr>  \
                          <td width="40%">Titipan Wakalah</td> \
                          <td>:</td> \
                          <td>'+((response.gl_titipan_wakalah==null)?"-":response.gl_titipan_wakalah)+'</td> \
                        </tr> \
                        <tr>  \
                          <td width="40%">Persediaan MBA</td> \
                          <td>:</td> \
                          <td>'+((response.gl_persediaan_mba==null)?"-":response.gl_persediaan_mba)+'</td> \
                        </tr> \
                        <tr>  \
                          <td width="40%">Uang Muka</td> \
                          <td>:</td> \
                          <td>'+((response.gl_uangmuka==null)?"-":response.gl_uangmuka)+'</td> \
                        </tr> \
                        <tr>  \
                          <td width="40%">Mukasah</td> \
                          <td>:</td> \
                          <td>'+((response.gl_mukasah==null)?"-":response.gl_mukasah)+'</td> \
                        </tr> \
                        <tr>  \
                          <td width="40%">Simpanan Wajib Pinjam</td> \
                          <td>:</td> \
                          <td>'+((response.gl_simpanan_wajib_pinjam==null)?"-":response.gl_simpanan_wajib_pinjam)+'</td> \
                        </tr> \
                        <tr>  \
                          <td width="40%">GL Titipan Pencairan</td> \
                          <td>:</td> \
                          <td>'+((response.gl_titipan_pencairan==null)?"-":response.gl_titipan_pencairan)+'</td> \
                        </tr> \
                        </table> ';
            $("#gl_detail").html(html);     
          }
      ...
      $("a#link-edit").live('click',function(){
        ...
        $.ajax({
          ...
          dataType: "json",
          data: {product_financing_gl_id:product_financing_gl_id},
          url: site_url+"product/get_financing_gl_by_product_id_hutang",
          success: function(response)
          {
            if (response.gl_saldo_tab_wajib==null &&response.gl_saldo_tab_kelompok==null &&response.gl_saldo_tab_sukarela==null ) 
            {                
              $("#jenis_gl, #form_edit").val("2"); 
              $("#gl_saldo_tab_wajib2, #form_edit").closest('.control-group').hide();
              $("#gl_saldo_tab_kelompok2, #form_edit").closest('.control-group').hide();
              $("#gl_saldo_tab_sukarela2, #form_edit").closest('.control-group').hide();
            }
            else
            {
              $("#jenis_gl, #form_edit").val("1"); 
            ...
            $("#product_financing_gl_id, #form_edit").val(response.product_financing_gl_id); 
            $("#product_financing_gl_code, #form_edit").val(response.product_financing_gl_code); 
            $("#description, #form_edit").val(response.description); 
            $("#gl_saldo_pokok2, #form_edit").val(response.gl_saldo_pokok).trigger('liszt:updated'); 
            $("#gl_saldo_margin2, #form_edit").val(response.gl_saldo_margin).trigger('liszt:updated'); 
            $("#gl_saldo_catab2, #form_edit").val(response.gl_saldo_catab).trigger('liszt:updated'); 
            $("#gl_saldo_tab_wajib2, #form_edit").val(response.gl_saldo_tab_wajib).trigger('liszt:updated'); 
            $("#gl_saldo_tab_kelompok2, #form_edit").val(response.gl_saldo_tab_kelompok).trigger('liszt:updated'); 
            $("#gl_saldo_tab_sukarela2, #form_edit").val(response.gl_saldo_tab_sukarela).trigger('liszt:updated'); 
            $("#gl_saldo_cad_resiko2, #form_edit").val(response.gl_saldo_cad_resiko).trigger('liszt:updated'); 
            $("#gl_pendapatan_margin2, #form_edit").val(response.gl_pendapatan_margin).trigger('liszt:updated'); 
            $("#gl_pendapatan_adm2, #form_edit").val(response.gl_pendapatan_adm).trigger('liszt:updated'); 
            $("#gl_asuransi_jiwa2, #form_edit").val(response.gl_asuransi_jiwa).trigger('liszt:updated'); 
            $("#gl_asuransi_jaminan2, #form_edit").val(response.gl_asuransi_jaminan).trigger('liszt:updated'); 
            $("#gl_biaya_cpp2, #form_edit").val(response.gl_biaya_cpp).trigger('liszt:updated'); 
            $("#gl_cpp2, #form_edit").val(response.gl_cpp).trigger('liszt:updated'); 
            $("#gl_biaya_notaris2, #form_edit").val(response.gl_biaya_notaris).trigger('liszt:updated'); 
            $("#gl_titipan_wakalah2, #form_edit").val(response.gl_titipan_wakalah).trigger('liszt:updated'); 
            $("#gl_persediaan_mba2, #form_edit").val(response.gl_persediaan_mba).trigger('liszt:updated'); 
            $("#gl_uangmuka2, #form_edit").val(response.gl_uangmuka).trigger('liszt:updated'); 
            $("#gl_mukasah2, #form_edit").val(response.gl_mukasah).trigger('liszt:updated'); 
            $("#gl_simpanan_wajib_pinjam2, #form_edit").val(response.gl_simpanan_wajib_pinjam).trigger('liszt:updated'); 
            $("#gl_titipan_pencairan2, #form_edit").val(response.gl_titipan_pencairan).trigger('liszt:updated'); 
          }
        });
      ...
      // UNTUK MENGHILANGKAN BEBERAPA FIELD GL
      $("#jenis_gl","#form_edit").change(function()
      {
        var jenis_gl = $("#jenis_gl","#form_edit").val();
          if (jenis_gl=='2') 
          {
            $("#gl_saldo_tab_wajib2","#form_edit").parent().parent().hide();
            $("#gl_saldo_tab_kelompok2","#form_edit").parent().parent().hide();
            ...
            $("#gl_saldo_tab_wajib","#form_edit").attr("disabled", true);
            $("#gl_saldo_tab_kelompok","#form_edit").attr("disabled", true);
            $("#gl_saldo_tab_sukarela","#form_edit").attr("disabled", true);
            $("#gl_saldo_tab_wajib","#form_edit").css("backgroundColor", "#EFEFEF");
            $("#gl_saldo_tab_kelompok","#form_edit").css("backgroundColor", "#EFEFEF");
            $("#gl_saldo_tab_sukarela","#form_edit").css("backgroundColor", "#EFEFEF");*/
          }
          else
          {
            ...
            $("#gl_saldo_tab_wajib","#form_edit").attr("disabled", false);
            $("#gl_saldo_tab_kelompok","#form_edit").attr("disabled", false);
            $("#gl_saldo_tab_sukarela","#form_edit").attr("disabled", false);
            $("#gl_saldo_tab_wajib","#form_edit").css("backgroundColor", "#FFFFFF");
            $("#gl_saldo_tab_kelompok","#form_edit").css("backgroundColor", "#FFFFFF");
            $("#gl_saldo_tab_sukarela","#form_edit").css("backgroundColor", "#FFFFFF");*/
          }
      });
      ...
      form2.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/edit_produk_gl_pembiayaan_hutang",
              dataType: "json",
      ...
      $("#btn_delete").click(function(){
        ...
        if(product_financing_gl_id.length==0){
          ...
          if(conf){
            $.ajax({
              type: "POST",
              url: site_url+"product/delete_produk_gl_pembiayaan_hutang",
              dataType: "json",
              data: {product_financing_gl_id:product_financing_gl_id},
              success: function(response){
                if(response.success==true){
      ...
      $('#produk_tabungan').dataTable({
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": site_url+"product/datatable_produk_gl_pembiayaan_hutang",
          "aoColumns": [
