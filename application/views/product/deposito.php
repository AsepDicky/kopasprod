...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Product Setup <small>Produk Deposito</small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
...
<div class="portlet box blue" id="wrapper-table">
   <div class="portlet-title">
      <div class="caption"><i class="icon-globe"></i>Produk Deposito</div>
      <div class="tools">
      ...
      <table class="table table-striped table-bordered table-hover" id="produk_deposito">
         <thead>
            <tr>
               ...
               <th width="14%">Minimal Nominal</th>
               <th width="14%">Akad</th>
...
<div id="add" class="hide">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Tambah Produk Deposito</div>
         <div class="tools">
            <a href="javascript:;" class="collapse"></a>
         </div>
      </div>
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
               ...
               <label class="control-label">Minimal Nominal<span class="required">*</span></label>               
                 <div class="controls">
                    <div class="input-prepend input-append">
                       ...
                       <input type="text" name="minimal_nominal" id="minimal_nominal" data-required="1" class="medium m-wrap mask-money"/>
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" name="pajak" id="pajak" data-required="1" class="small m-wrap"/> %
               </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="product_deposit_gl_code" id="product_deposit_gl_code" class="medium m-wrap" data-required="1">
                     <option value="">PILIH</option>
                     <?php
                     foreach ($gl_code as $data): 
                     ?>
                     <option value="<?php echo $data['product_deposit_gl_code'];?>"><?php echo $data['description'];?></option>
                   <?php endforeach; ?>
                  </select>
               </div>
            </div>
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="product_status" id="product_status" class="small m-wrap" data-required="1">
   ...
   <div class="portlet box purple">
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_edit" class="form-horizontal">
          <input type="hidden" id="product_deposit_id" name="product_deposit_id">
            <div class="alert alert-error hide">
               <button class="close" data-dismiss="alert"></button>
               You have some form errors. Please check below.
            </div>
            ...
            <div class="control-group">
               <label class="control-label">Kode Produk<span class="required">*</span></label>
               <div class="controls">
                  <input type="text" name="product_code2" id="product_code2" data-required="1" class="medium m-wrap"  onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" />
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">Nama Produk<span class="required">*</span></label>
            ...
            <div class="control-group">
               <label class="control-label">Minimal Nominal<span class="required">*</span></label>               
                 <div class="controls">
                    <div class="input-prepend input-append">
                       <span class="add-on">Rp</span>
                       <input type="text" name="minimal_nominal2" id="minimal_nominal2" data-required="1" class="medium m-wrap mask-money"/>
                       <span class="add-on">,00</span>
                     </div>
                 </div>
            </div>
            ...
            <div class="control-group">
               <label class="control-label">Pajak<span class="required">*</span></label>
               <div class="controls">
                  <input type="text" name="pajak2" id="pajak2" data-required="1" class="small m-wrap"/> %
               </div>
            </div>
            <div class="control-group">
               <label class="control-label">Persen Pajak<span class="required">*</span></label>
            ...
            <div class="control-group">
               <label class="control-label">Status<span class="required">*</span></label>
               <div class="controls">
                  <select name="product_status2" id="product_status2" class="small m-wrap" data-required="1">
                     <option value="0">Aktif</option>
                     <option value="1">Tidak Aktif</option>
                  </select>
               </div>
...
$(function(){
      ...
      form1.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/add_produk_deposito",
              dataType: "json",
      ...
      $("a#link-edit").live('click',function(){
        $("#wrapper-table").hide();
        $("#edit").show();
        var product_deposit_id = $(this).attr('product_deposit_id');

        $.ajax({
          type: "POST",
          dataType: "json",
          data: {product_deposit_id:product_deposit_id},
          url: site_url+"product/get_deposito_by_product_id",
          success: function(response)
          {
            $("#product_deposit_id").val(response.product_deposit_id);
            $("#product_code2").val(response.product_code);
            $("#product_name2").val(response.product_name);
            $("#nick_name2").val(response.nick_name);
            $("#minimal_nominal2").val(response.minimal_nominal);
            $("#akad2").val(response.akad);
            $("#pajak2").val(response.pajak);
            $("#persen_pajak2").val(response.persen_pajak);
            $("#product_status2").val(response.product_status);
      ...
      form2.validate({
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              type: "POST",
              url: site_url+"product/edit_produk_deposito",
              dataType: "json",
      ...
      $("#btn_delete").click(function(){
        ...
        var product_deposit_id = [];
        var $i = 0;
        $("input#checkbox:checked").each(function(){

          product_deposit_id[$i] = $(this).val();

          $i++;

        });

        if(product_deposit_id.length==0){
          ...
          if(conf){
            $.ajax({
              type: "POST",
              url: site_url+"product/delete_produk_deposito",
              dataType: "json",
              data: {product_deposit_id:product_deposit_id},
              success: function(response){
                if(response.success==true){
      ...
      $('#produk_deposito').dataTable({
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": site_url+"product/datatable_produk_deposito",
          "aoColumns": [
            {"bSearchable": false}
            ,null
            ,null
