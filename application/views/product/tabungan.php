   ...
   <div class="portlet box green">
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select name="akad" id="akad" class="medium m-wrap">
                    ...
                    <option value="0">WADIAH</option>
                    <option value="1">MUDARABAH</option>
                  </select>
               </div>
            </div>
            <div class="control-group" id="div_nisbah_by_akad" style="display:none;">
               <label class="control-label">Nisbah Bagi Hasil<span class="required">*</span></label>
               <div class="controls">
                  <input type="text" name="nisbah_bagi_hasil" id="nisbah_bagi_hasil" data-required="1" class="small m-wrap" placeholder="00.00"/>
               </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group" style="display:nones">
               <label class="control-label">Batas Maksimal Tidak Bermutasi (bulan)<span class="required">*</span></label>        
                 <div class="controls">
                  <input type="text" name="maksimal_tidak_bermutasi" id="maksimal_tidak_bermutasi" data-required="1" class="small m-wrap"/>
                 </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
               <label class="control-label">Pajak Bonus/Bahas<span class="required">*</span></label>
               <div class="controls">
            ...
            <div class="control-group">
               <label class="control-label">Persen Pajak Bonus/Bahas<span class="required">*</span></label>
               <div class="controls">
                  <input type="text" name="persen_pajak" id="persen_pajak" data-required="1" class="small m-wrap"/> %
               </div>
            </div>
            <div class="control-group" style="display:nones">
               <label class="control-label">Batas Minimal Kena Pajak<span class="required">*</span></label>        
                 <div class="controls">
                    <div class="input-prepend input-append">
                       <span class="add-on">Rp</span>
                       <input type="text" name="minimal_kena_pajak" id="minimal_kena_pajak" data-required="1" class="medium m-wrap mask-money"/>
                       <span class="add-on">,00</span>
                     </div>
                 </div>
            </div>
...
$(function(){
      ...
      $("#akad","#add").click(function(){
        akad_val = $("#akad","#add").val();
        if (akad_val==1) 
        {
          $("#div_nisbah_by_akad","#add").show();
        } 
        else
        {
          $("#div_nisbah_by_akad","#add").hide();
        }
      });

      $("#akad2","#edit").click(function(){
        akad_val = $("#akad","#edit").val();
        if (akad_val==1) 
        {
          $("#div_nisbah_by_akad","#edit").show();
        } 
        else
        {
          $("#div_nisbah_by_akad","#edit").hide();
        }
      });
        ...
        $.ajax({
          ...
          success: function(response)
          {
            ...
            $("#product_saving_gl_code, #form_edit").val(response.product_saving_gl_code);
              ...
              {
                $("#div_nisbah_by_akad","#edit").show();
                $("#nisbah_bagi_hasil","#edit").val(response.nisbah);
              } 
              else
              {
                $("#div_nisbah_by_akad","#edit").hide();
