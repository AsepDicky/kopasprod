...
var App = function () {
    ...
    var handleUniform = function () {
        ...
        var test = $("input[type=checkbox]:not(.toggle), input[type=radio][uniform='true']:not(.toggle, .star)");
        if (test.size() > 0) {
            test.each(function(){
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", base_url+"assets/css/themes/" + color + ".css");
        }
    ...
    return {
        ...
        SuccessAlert: function(content,callback){
            $.alert({
                title:'Success',icon:'icon-check',content:content,
        ...
        ErrorAlert: function(content,callback){
            $.alert({
                title:'Error',icon:'icon-warning-sign',content:content,
        ...
        ConfirmAlert: function(content,callback){
            $.confirm({
                title:'Message',icon:'icon-warning-sign',content:content,
        ...
        WarningAlert: function(content){
            $.alert({
                title:'Warning',icon:'icon-warning-sign',content:content,
                confirmButtonClass:'btn yellow',animation:'zoom'
            })
        },
